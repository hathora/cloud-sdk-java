...
public class RoomsV2 implements
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateRoomRequestBuilder createRoom() {
        return new com.hathora.cloud_api.models.operations.CreateRoomRequestBuilder(this);
    }
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateRoomResponse createRoom(
            com.hathora.cloud_api.models.shared.CreateRoomParams createRoomParams) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.CreateRoomResponse createRoom(
        ...
        com.hathora.cloud_api.models.operations.CreateRoomRequest request =
            com.hathora.cloud_api.models.operations.CreateRoomRequest
                .builder()
        ...
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.CreateRoomRequest.class,
                _baseUrl,
        ...
        com.hathora.cloud_api.models.operations.CreateRoomResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.CreateRoomResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.CreateRoomResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "201")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.RoomConnectionData _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.RoomConnectionData>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.DestroyRoomRequestBuilder destroyRoom() {
        return new com.hathora.cloud_api.models.operations.DestroyRoomRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.DestroyRoomResponse destroyRoom(
    ...
    public com.hathora.cloud_api.models.operations.DestroyRoomResponse destroyRoom(
            Optional<? extends String> appId,
            String roomId) throws Exception {
        com.hathora.cloud_api.models.operations.DestroyRoomRequest request =
            com.hathora.cloud_api.models.operations.DestroyRoomRequest
                .builder()
                .appId(appId)
                .roomId(roomId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.DestroyRoomRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.DestroyRoomResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.DestroyRoomResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.DestroyRoomResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessRequestBuilder getActiveRoomsForProcess() {
        return new com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessResponse getActiveRoomsForProcess(
    ...
    public com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessResponse getActiveRoomsForProcess(
            Optional<? extends String> appId,
            String processId) throws Exception {
        com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessRequest request =
            com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessRequest
                .builder()
                .appId(appId)
                .processId(processId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetActiveRoomsForProcessResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                java.util.List<com.hathora.cloud_api.models.shared.RoomWithoutAllocations> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<java.util.List<com.hathora.cloud_api.models.shared.RoomWithoutAllocations>>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetConnectionInfoRequestBuilder getConnectionInfo() {
        return new com.hathora.cloud_api.models.operations.GetConnectionInfoRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetConnectionInfoResponse getConnectionInfo(
            String roomId) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.GetConnectionInfoResponse getConnectionInfo(
            Optional<? extends String> appId,
            String roomId) throws Exception {
        com.hathora.cloud_api.models.operations.GetConnectionInfoRequest request =
            com.hathora.cloud_api.models.operations.GetConnectionInfoRequest
                .builder()
                .appId(appId)
                .roomId(roomId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetConnectionInfoRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetConnectionInfoResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetConnectionInfoResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetConnectionInfoResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.ConnectionInfoV2 _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.ConnectionInfoV2>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessRequestBuilder getInactiveRoomsForProcess() {
        return new com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessResponse getInactiveRoomsForProcess(
            String processId) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessResponse getInactiveRoomsForProcess(
            Optional<? extends String> appId,
            String processId) throws Exception {
        com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessRequest request =
            com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessRequest
                .builder()
                .appId(appId)
                .processId(processId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetInactiveRoomsForProcessResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetRoomInfoRequestBuilder getRoomInfo() {
        return new com.hathora.cloud_api.models.operations.GetRoomInfoRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetRoomInfoResponse getRoomInfo(
            String roomId) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.GetRoomInfoResponse getRoomInfo(
            Optional<? extends String> appId,
            String roomId) throws Exception {
        com.hathora.cloud_api.models.operations.GetRoomInfoRequest request =
            com.hathora.cloud_api.models.operations.GetRoomInfoRequest
                .builder()
                .appId(appId)
                .roomId(roomId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetRoomInfoRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetRoomInfoResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetRoomInfoResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetRoomInfoResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.Room _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.Room>() {});
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedRequestBuilder suspendRoomV2Deprecated() {
        return new com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedRequestBuilder(this);
    }
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedResponse suspendRoomV2Deprecated(
            String roomId) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedResponse suspendRoomV2Deprecated(
            Optional<? extends String> appId,
            String roomId) throws Exception {
        com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedRequest request =
            com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedRequest
                .builder()
                .appId(appId)
                .roomId(roomId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.SuspendRoomV2DeprecatedResponse _res = _resBuilder.build();
    ...
    public com.hathora.cloud_api.models.operations.UpdateRoomConfigRequestBuilder updateRoomConfig() {
        return new com.hathora.cloud_api.models.operations.UpdateRoomConfigRequestBuilder(this);
    }

    public com.hathora.cloud_api.models.operations.UpdateRoomConfigResponse updateRoomConfig(
    ...
    public com.hathora.cloud_api.models.operations.UpdateRoomConfigResponse updateRoomConfig(
            ...
            Optional<? extends String> appId,
            String roomId) throws Exception {
        com.hathora.cloud_api.models.operations.UpdateRoomConfigRequest request =
            com.hathora.cloud_api.models.operations.UpdateRoomConfigRequest
                .builder()
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.UpdateRoomConfigRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.UpdateRoomConfigResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.UpdateRoomConfigResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.UpdateRoomConfigResponse _res = _resBuilder.build();
