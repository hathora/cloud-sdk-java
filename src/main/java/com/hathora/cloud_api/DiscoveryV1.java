...
public class DiscoveryV1 implements
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetPingServiceEndpointsDeprecatedRequestBuilder getPingServiceEndpointsDeprecated() {
        return new com.hathora.cloud_api.models.operations.GetPingServiceEndpointsDeprecatedRequestBuilder(this);
    }
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetPingServiceEndpointsDeprecatedResponse getPingServiceEndpointsDeprecatedDirect() throws Exception {
        ...
        com.hathora.cloud_api.models.operations.GetPingServiceEndpointsDeprecatedResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetPingServiceEndpointsDeprecatedResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetPingServiceEndpointsDeprecatedResponse _res = _resBuilder.build();
