...
public class CreateLocalLobbyResponse implements com.hathora.cloud_api.utils.Response {
    ...
    public CreateLocalLobbyResponse withLobby(com.hathora.cloud_api.models.shared.Lobby lobby) {
        Utils.checkNotNull(lobby, "lobby");
        this.lobby = Optional.ofNullable(lobby);
        return this;
    }

    public CreateLocalLobbyResponse withLobby(Optional<? extends com.hathora.cloud_api.models.shared.Lobby> lobby) {
        Utils.checkNotNull(lobby, "lobby");
        this.lobby = lobby;
        return this;
    }
