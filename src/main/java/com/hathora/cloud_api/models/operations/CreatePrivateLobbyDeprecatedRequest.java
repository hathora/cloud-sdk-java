...
public class CreatePrivateLobbyDeprecatedRequest {
    ...
    public CreatePrivateLobbyDeprecatedRequest withAppId(Optional<? extends String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
    ...
    public CreatePrivateLobbyDeprecatedRequest withLocal(Optional<? extends Boolean> local) {
        Utils.checkNotNull(local, "local");
        this.local = local;
        return this;
    }

    public CreatePrivateLobbyDeprecatedRequest withRegion(com.hathora.cloud_api.models.shared.Region region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.ofNullable(region);
        return this;
    }

    public CreatePrivateLobbyDeprecatedRequest withRegion(Optional<? extends com.hathora.cloud_api.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
