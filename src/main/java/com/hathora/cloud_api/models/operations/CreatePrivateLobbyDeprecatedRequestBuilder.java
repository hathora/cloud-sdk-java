...
public class CreatePrivateLobbyDeprecatedRequestBuilder {
    ...
    public CreatePrivateLobbyDeprecatedRequestBuilder region(com.hathora.cloud_api.models.shared.Region region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.of(region);
        return this;
    }

    public CreatePrivateLobbyDeprecatedRequestBuilder region(Optional<? extends com.hathora.cloud_api.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
