...
public class CreatePublicLobbyResponse implements com.hathora.cloud_api.utils.Response {
    ...
    public CreatePublicLobbyResponse withLobby(com.hathora.cloud_api.models.shared.Lobby lobby) {
        Utils.checkNotNull(lobby, "lobby");
        this.lobby = Optional.ofNullable(lobby);
        return this;
    }

    public CreatePublicLobbyResponse withLobby(Optional<? extends com.hathora.cloud_api.models.shared.Lobby> lobby) {
        Utils.checkNotNull(lobby, "lobby");
        this.lobby = lobby;
        return this;
    }
