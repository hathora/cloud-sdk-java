...
public class CreatePublicLobbyRequestBody {
    ...
    public CreatePublicLobbyRequestBody(
            ...
            @JsonProperty("region") com.hathora.cloud_api.models.shared.Region region) {
    ...
    public CreatePublicLobbyRequestBody withRegion(com.hathora.cloud_api.models.shared.Region region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
