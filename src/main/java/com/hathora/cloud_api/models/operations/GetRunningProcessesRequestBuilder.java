...
public class GetRunningProcessesRequestBuilder {
    ...
    public GetRunningProcessesRequestBuilder region(com.hathora.cloud_api.models.shared.Region region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.of(region);
        return this;
    }

    public GetRunningProcessesRequestBuilder region(Optional<? extends com.hathora.cloud_api.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
