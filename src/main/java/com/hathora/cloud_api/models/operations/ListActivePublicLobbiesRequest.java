...
public class ListActivePublicLobbiesRequest {
     ...
     * If omitted, active public lobbies in all regions will be returned.
     */
    public ListActivePublicLobbiesRequest withRegion(com.hathora.cloud_api.models.shared.Region region) {
        Utils.checkNotNull(region, "region");
     ...
     * If omitted, active public lobbies in all regions will be returned.
     */
    public ListActivePublicLobbiesRequest withRegion(Optional<? extends com.hathora.cloud_api.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
