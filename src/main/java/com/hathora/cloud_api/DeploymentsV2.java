...
public class DeploymentsV2 implements
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateDeploymentRequestBuilder createDeployment() {
        return new com.hathora.cloud_api.models.operations.CreateDeploymentRequestBuilder(this);
    }
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateDeploymentResponse createDeployment(
    ...
    public com.hathora.cloud_api.models.operations.CreateDeploymentResponse createDeployment(
            ...
            int buildId) throws Exception {
        com.hathora.cloud_api.models.operations.CreateDeploymentRequest request =
            com.hathora.cloud_api.models.operations.CreateDeploymentRequest
                .builder()
        ...
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.CreateDeploymentRequest.class,
                _baseUrl,
        ...
        com.hathora.cloud_api.models.operations.CreateDeploymentResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.CreateDeploymentResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.CreateDeploymentResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "201")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.DeploymentV2 _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.DeploymentV2>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetDeploymentInfoRequestBuilder getDeploymentInfo() {
        return new com.hathora.cloud_api.models.operations.GetDeploymentInfoRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetDeploymentInfoResponse getDeploymentInfo(
    ...
    public com.hathora.cloud_api.models.operations.GetDeploymentInfoResponse getDeploymentInfo(
            Optional<? extends String> appId,
            int deploymentId) throws Exception {
        com.hathora.cloud_api.models.operations.GetDeploymentInfoRequest request =
            com.hathora.cloud_api.models.operations.GetDeploymentInfoRequest
                .builder()
                .appId(appId)
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetDeploymentInfoRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetDeploymentInfoResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetDeploymentInfoResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetDeploymentInfoResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetDeploymentsRequestBuilder getDeployments() {
        return new com.hathora.cloud_api.models.operations.GetDeploymentsRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetDeploymentsResponse getDeploymentsDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetDeploymentsResponse getDeployments(
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.GetDeploymentsRequest request =
            com.hathora.cloud_api.models.operations.GetDeploymentsRequest
                .builder()
                .appId(appId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetDeploymentsRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetDeploymentsResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetDeploymentsResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetDeploymentsResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                java.util.List<com.hathora.cloud_api.models.shared.DeploymentV2> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<java.util.List<com.hathora.cloud_api.models.shared.DeploymentV2>>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetLatestDeploymentRequestBuilder getLatestDeployment() {
        return new com.hathora.cloud_api.models.operations.GetLatestDeploymentRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetLatestDeploymentResponse getLatestDeploymentDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetLatestDeploymentResponse getLatestDeployment(
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.GetLatestDeploymentRequest request =
            com.hathora.cloud_api.models.operations.GetLatestDeploymentRequest
                .builder()
                .appId(appId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetLatestDeploymentRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetLatestDeploymentResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetLatestDeploymentResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetLatestDeploymentResponse _res = _resBuilder.build();
