...
public class AppsV1 implements
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateAppRequestBuilder createApp() {
        return new com.hathora.cloud_api.models.operations.CreateAppRequestBuilder(this);
    }
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateAppResponse createApp(
        ...
        Object _convertedRequest = Utils.convertToShape(request, Utils.JsonShape.DEFAULT,
            new TypeReference<com.hathora.cloud_api.models.shared.AppConfig>() {});
        ...
        com.hathora.cloud_api.models.operations.CreateAppResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.CreateAppResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.CreateAppResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "201")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.Application _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.Application>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.DeleteAppRequestBuilder deleteApp() {
        return new com.hathora.cloud_api.models.operations.DeleteAppRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.DeleteAppResponse deleteAppDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.DeleteAppResponse deleteApp(
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.DeleteAppRequest request =
            com.hathora.cloud_api.models.operations.DeleteAppRequest
                .builder()
                .appId(appId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.DeleteAppRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.DeleteAppResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.DeleteAppResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.DeleteAppResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetAppInfoRequestBuilder getAppInfo() {
        return new com.hathora.cloud_api.models.operations.GetAppInfoRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetAppInfoResponse getAppInfoDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetAppInfoResponse getAppInfo(
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.GetAppInfoRequest request =
            com.hathora.cloud_api.models.operations.GetAppInfoRequest
                .builder()
                .appId(appId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetAppInfoRequest.class,
                _baseUrl,
                "/apps/v1/info/{appId}",
                request, this.sdkConfiguration.globals);
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetAppInfoResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetAppInfoResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetAppInfoResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetAppsRequestBuilder getApps() {
        return new com.hathora.cloud_api.models.operations.GetAppsRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetAppsResponse getAppsDirect() throws Exception {
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                _baseUrl,
                "/apps/v1/list");
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetAppsResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetAppsResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetAppsResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                java.util.List<com.hathora.cloud_api.models.shared.ApplicationWithLatestDeploymentAndBuild> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<java.util.List<com.hathora.cloud_api.models.shared.ApplicationWithLatestDeploymentAndBuild>>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.UpdateAppRequestBuilder updateApp() {
        return new com.hathora.cloud_api.models.operations.UpdateAppRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.UpdateAppResponse updateApp(
            com.hathora.cloud_api.models.shared.AppConfig appConfig) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.UpdateAppResponse updateApp(
            ...
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.UpdateAppRequest request =
            com.hathora.cloud_api.models.operations.UpdateAppRequest
                .builder()
                .appConfig(appConfig)
                .appId(appId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.UpdateAppRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.UpdateAppResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.UpdateAppResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.UpdateAppResponse _res = _resBuilder.build();
