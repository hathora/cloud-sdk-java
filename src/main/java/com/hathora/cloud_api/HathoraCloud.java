...
import com.hathora.cloud_api.utils.SpeakeasyHTTPClient;
...
public class HathoraCloud {
    ...
    public static class Builder {
         ...
         * @return The builder instance.
         */
        public Builder security(com.hathora.cloud_api.models.shared.Security security) {
        ...
        public Builder serverURL(String serverUrl, java.util.Map<String, String> params) {
            this.sdkConfiguration.serverUrl = com.hathora.cloud_api.utils.Utils.templateUrl(serverUrl, params);
            return this;
        }
