...
public class ProcessesV1 implements
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedRequestBuilder getProcessInfoDeprecated() {
        return new com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedRequestBuilder(this);
    }
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedResponse getProcessInfoDeprecated(
    ...
    public com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedResponse getProcessInfoDeprecated(
            ...
            String processId) throws Exception {
        com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedRequest request =
            com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedRequest
                .builder()
                .appId(appId)
                .processId(processId)
                .build();
        ...
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedRequest.class,
                _baseUrl,
        ...
        com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetProcessInfoDeprecatedResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.Process _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.Process>() {});
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetRunningProcessesRequestBuilder getRunningProcesses() {
        return new com.hathora.cloud_api.models.operations.GetRunningProcessesRequestBuilder(this);
    }
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetRunningProcessesResponse getRunningProcessesDirect() throws Exception {
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetRunningProcessesResponse getRunningProcesses(
            Optional<? extends String> appId,
            Optional<? extends com.hathora.cloud_api.models.shared.Region> region) throws Exception {
        com.hathora.cloud_api.models.operations.GetRunningProcessesRequest request =
            com.hathora.cloud_api.models.operations.GetRunningProcessesRequest
                .builder()
                .appId(appId)
                .region(region)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetRunningProcessesRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetRunningProcessesResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetRunningProcessesResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetRunningProcessesResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                java.util.List<com.hathora.cloud_api.models.shared.ProcessWithRooms> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<java.util.List<com.hathora.cloud_api.models.shared.ProcessWithRooms>>() {});
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetStoppedProcessesRequestBuilder getStoppedProcesses() {
        return new com.hathora.cloud_api.models.operations.GetStoppedProcessesRequestBuilder(this);
    }
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetStoppedProcessesResponse getStoppedProcessesDirect() throws Exception {
     ...
     */
    @Deprecated
    public com.hathora.cloud_api.models.operations.GetStoppedProcessesResponse getStoppedProcesses(
            Optional<? extends String> appId,
            Optional<? extends com.hathora.cloud_api.models.shared.Region> region) throws Exception {
        com.hathora.cloud_api.models.operations.GetStoppedProcessesRequest request =
            com.hathora.cloud_api.models.operations.GetStoppedProcessesRequest
                .builder()
                .appId(appId)
                .region(region)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetStoppedProcessesRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetStoppedProcessesResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetStoppedProcessesResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetStoppedProcessesResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                java.util.List<com.hathora.cloud_api.models.shared.Process> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<java.util.List<com.hathora.cloud_api.models.shared.Process>>() {});
                _res.withClasses(java.util.Optional.ofNullable(_out));
                return _res;
            } else {
                throw new SDKError(
