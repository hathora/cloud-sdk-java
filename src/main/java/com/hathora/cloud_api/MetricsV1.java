...
public class MetricsV1 implements
     ...
     */
    public com.hathora.cloud_api.models.operations.GetMetricsRequestBuilder getMetrics() {
        return new com.hathora.cloud_api.models.operations.GetMetricsRequestBuilder(this);
    }
     ...
     */
    public com.hathora.cloud_api.models.operations.GetMetricsResponse getMetrics(
            com.hathora.cloud_api.models.operations.GetMetricsRequest request) throws Exception {
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetMetricsRequest.class,
                _baseUrl,
        ...
        com.hathora.cloud_api.models.operations.GetMetricsResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetMetricsResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetMetricsResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.MetricsData _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.MetricsData>() {});
