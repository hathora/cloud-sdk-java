...
public class BuildsV2 implements
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateBuildRequestBuilder createBuild() {
        return new com.hathora.cloud_api.models.operations.CreateBuildRequestBuilder(this);
    }
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateBuildResponse createBuild(
    ...
    public com.hathora.cloud_api.models.operations.CreateBuildResponse createBuild(
        ...
        com.hathora.cloud_api.models.operations.CreateBuildRequest request =
            com.hathora.cloud_api.models.operations.CreateBuildRequest
                .builder()
        ...
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.CreateBuildRequest.class,
                _baseUrl,
        ...
        com.hathora.cloud_api.models.operations.CreateBuildResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.CreateBuildResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.CreateBuildResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlRequestBuilder createBuildWithUploadUrl() {
        return new com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlResponse createBuildWithUploadUrl(
            com.hathora.cloud_api.models.shared.CreateBuildParams createBuildParams) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlResponse createBuildWithUploadUrl(
            com.hathora.cloud_api.models.shared.CreateBuildParams createBuildParams,
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlRequest request =
            com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlRequest
                .builder()
                .createBuildParams(createBuildParams)
                .appId(appId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.CreateBuildWithUploadUrlResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "201")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.BuildWithUploadUrl _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.BuildWithUploadUrl>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.DeleteBuildRequestBuilder deleteBuild() {
        return new com.hathora.cloud_api.models.operations.DeleteBuildRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.DeleteBuildResponse deleteBuild(
    ...
    public com.hathora.cloud_api.models.operations.DeleteBuildResponse deleteBuild(
            ...
            int buildId) throws Exception {
        com.hathora.cloud_api.models.operations.DeleteBuildRequest request =
            com.hathora.cloud_api.models.operations.DeleteBuildRequest
                .builder()
                .appId(appId)
                .buildId(buildId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.DeleteBuildRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.DeleteBuildResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.DeleteBuildResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.DeleteBuildResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetBuildInfoRequestBuilder getBuildInfo() {
        return new com.hathora.cloud_api.models.operations.GetBuildInfoRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetBuildInfoResponse getBuildInfo(
            int buildId) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.GetBuildInfoResponse getBuildInfo(
            Optional<? extends String> appId,
            int buildId) throws Exception {
        com.hathora.cloud_api.models.operations.GetBuildInfoRequest request =
            com.hathora.cloud_api.models.operations.GetBuildInfoRequest
                .builder()
                .appId(appId)
                .buildId(buildId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetBuildInfoRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetBuildInfoResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetBuildInfoResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetBuildInfoResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetBuildsRequestBuilder getBuilds() {
        return new com.hathora.cloud_api.models.operations.GetBuildsRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetBuildsResponse getBuildsDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetBuildsResponse getBuilds(
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.GetBuildsRequest request =
            com.hathora.cloud_api.models.operations.GetBuildsRequest
                .builder()
                .appId(appId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetBuildsRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetBuildsResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetBuildsResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetBuildsResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.RunBuildRequestBuilder runBuild() {
        return new com.hathora.cloud_api.models.operations.RunBuildRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.RunBuildResponse runBuild(
    ...
    public com.hathora.cloud_api.models.operations.RunBuildResponse runBuild(
            ...
            Optional<? extends String> appId,
            int buildId) throws Exception {
        com.hathora.cloud_api.models.operations.RunBuildRequest request =
            com.hathora.cloud_api.models.operations.RunBuildRequest
                .builder()
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.RunBuildRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.RunBuildResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.RunBuildResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);
        ...
        com.hathora.cloud_api.models.operations.RunBuildResponse _res = _resBuilder.build();
