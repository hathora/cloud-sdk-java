...
public class TokensV1 implements
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateOrgTokenRequestBuilder createOrgToken() {
        return new com.hathora.cloud_api.models.operations.CreateOrgTokenRequestBuilder(this);
    }
     ...
     */
    public com.hathora.cloud_api.models.operations.CreateOrgTokenResponse createOrgToken(
            com.hathora.cloud_api.models.shared.CreateOrgToken createOrgToken,
            String orgId) throws Exception {
        com.hathora.cloud_api.models.operations.CreateOrgTokenRequest request =
            com.hathora.cloud_api.models.operations.CreateOrgTokenRequest
                .builder()
        ...
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.CreateOrgTokenRequest.class,
                _baseUrl,
        ...
        com.hathora.cloud_api.models.operations.CreateOrgTokenResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.CreateOrgTokenResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.CreateOrgTokenResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "201")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.CreatedOrgToken _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.CreatedOrgToken>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.GetOrgTokensRequestBuilder getOrgTokens() {
        return new com.hathora.cloud_api.models.operations.GetOrgTokensRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.GetOrgTokensResponse getOrgTokens(
            String orgId) throws Exception {
        com.hathora.cloud_api.models.operations.GetOrgTokensRequest request =
            com.hathora.cloud_api.models.operations.GetOrgTokensRequest
                .builder()
                .orgId(orgId)
                .build();
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.GetOrgTokensRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.GetOrgTokensResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.GetOrgTokensResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.GetOrgTokensResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.ListOrgTokens _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.ListOrgTokens>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.RevokeOrgTokenRequestBuilder revokeOrgToken() {
        return new com.hathora.cloud_api.models.operations.RevokeOrgTokenRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.RevokeOrgTokenResponse revokeOrgToken(
            String orgId,
            String orgTokenId) throws Exception {
        com.hathora.cloud_api.models.operations.RevokeOrgTokenRequest request =
            com.hathora.cloud_api.models.operations.RevokeOrgTokenRequest
                .builder()
                .orgId(orgId)
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.RevokeOrgTokenRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.RevokeOrgTokenResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.RevokeOrgTokenResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.RevokeOrgTokenResponse _res = _resBuilder.build();
