...
public class AuthV1 implements
     ...
     */
    public com.hathora.cloud_api.models.operations.LoginAnonymousRequestBuilder loginAnonymous() {
        return new com.hathora.cloud_api.models.operations.LoginAnonymousRequestBuilder(this);
    }
     ...
     */
    public com.hathora.cloud_api.models.operations.LoginAnonymousResponse loginAnonymousDirect() throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.LoginAnonymousResponse loginAnonymous(
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.LoginAnonymousRequest request =
            com.hathora.cloud_api.models.operations.LoginAnonymousRequest
                .builder()
                .appId(appId)
                .build();
        ...
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.LoginAnonymousRequest.class,
                _baseUrl,
        ...
        com.hathora.cloud_api.models.operations.LoginAnonymousResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.LoginAnonymousResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.LoginAnonymousResponse _res = _resBuilder.build();
        
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                com.hathora.cloud_api.models.shared.PlayerTokenObject _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<com.hathora.cloud_api.models.shared.PlayerTokenObject>() {});
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.LoginGoogleRequestBuilder loginGoogle() {
        return new com.hathora.cloud_api.models.operations.LoginGoogleRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.LoginGoogleResponse loginGoogle(
            com.hathora.cloud_api.models.shared.GoogleIdTokenObject googleIdTokenObject) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.LoginGoogleResponse loginGoogle(
            ...
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.LoginGoogleRequest request =
            com.hathora.cloud_api.models.operations.LoginGoogleRequest
                .builder()
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.LoginGoogleRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.LoginGoogleResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.LoginGoogleResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.LoginGoogleResponse _res = _resBuilder.build();
     ...
     * @return The call builder
     */
    public com.hathora.cloud_api.models.operations.LoginNicknameRequestBuilder loginNickname() {
        return new com.hathora.cloud_api.models.operations.LoginNicknameRequestBuilder(this);
    }
     ...
     * @throws Exception if the API call fails
     */
    public com.hathora.cloud_api.models.operations.LoginNicknameResponse loginNickname(
            com.hathora.cloud_api.models.shared.NicknameObject nicknameObject) throws Exception {
    ...
    public com.hathora.cloud_api.models.operations.LoginNicknameResponse loginNickname(
            ...
            Optional<? extends String> appId) throws Exception {
        com.hathora.cloud_api.models.operations.LoginNicknameRequest request =
            com.hathora.cloud_api.models.operations.LoginNicknameRequest
                .builder()
        ...
        String _baseUrl = this.sdkConfiguration.serverUrl;
        String _url = Utils.generateURL(
                com.hathora.cloud_api.models.operations.LoginNicknameRequest.class,
                _baseUrl,
        ...
        String _contentType = _httpRes
            ...
            .firstValue("Content-Type")
            .orElse("application/octet-stream");
        com.hathora.cloud_api.models.operations.LoginNicknameResponse.Builder _resBuilder = 
            com.hathora.cloud_api.models.operations.LoginNicknameResponse
                .builder()
                .contentType(_contentType)
                .statusCode(_httpRes.statusCode())
                .rawResponse(_httpRes);

        com.hathora.cloud_api.models.operations.LoginNicknameResponse _res = _resBuilder.build();
