...
public class CreateAppV1DeprecatedResponse implements Response {
    ...
    @JsonCreator
    public CreateAppV1DeprecatedResponse(
     ...
     * HTTP response content type for this operation
     */
    public CreateAppV1DeprecatedResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public CreateAppV1DeprecatedResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateAppV1DeprecatedResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(CreateAppV1DeprecatedResponse.class,
