...
public class GetRunningProcessesRequestBuilder {
    ...
    public GetRunningProcessesRequestBuilder region(com.hathora.hathora_cloud_sdk.models.shared.Region region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.of(region);
        return this;
    }

    public GetRunningProcessesRequestBuilder region(java.util.Optional<? extends com.hathora.hathora_cloud_sdk.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
