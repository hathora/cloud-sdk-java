...
public class ListActivePublicLobbiesDeprecatedV1RequestBuilder {
    ...
    public ListActivePublicLobbiesDeprecatedV1RequestBuilder region(com.hathora.hathora_cloud_sdk.models.shared.Region region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.of(region);
        return this;
    }

    public ListActivePublicLobbiesDeprecatedV1RequestBuilder region(java.util.Optional<? extends com.hathora.hathora_cloud_sdk.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
