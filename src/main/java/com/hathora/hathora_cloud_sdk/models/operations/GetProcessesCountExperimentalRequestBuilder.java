...
public class GetProcessesCountExperimentalRequestBuilder {
    ...
    public GetProcessesCountExperimentalRequestBuilder region(java.util.List<com.hathora.hathora_cloud_sdk.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.of(region);
        return this;
    }

    public GetProcessesCountExperimentalRequestBuilder region(java.util.Optional<? extends java.util.List<com.hathora.hathora_cloud_sdk.models.shared.Region>> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
                
    public GetProcessesCountExperimentalRequestBuilder status(java.util.List<com.hathora.hathora_cloud_sdk.models.shared.ProcessStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = Optional.of(status);
        return this;
    }

    public GetProcessesCountExperimentalRequestBuilder status(java.util.Optional<? extends java.util.List<com.hathora.hathora_cloud_sdk.models.shared.ProcessStatus>> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
