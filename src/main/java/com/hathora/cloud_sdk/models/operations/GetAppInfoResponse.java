...
public class GetAppInfoResponse implements com.hathora.cloud_sdk.utils.Response {
     ...
     * Ok
     */
    public GetAppInfoResponse withApplication(com.hathora.cloud_sdk.models.shared.Application application) {
        Utils.checkNotNull(application, "application");
     ...
     * Ok
     */
    public GetAppInfoResponse withApplication(Optional<? extends com.hathora.cloud_sdk.models.shared.Application> application) {
        Utils.checkNotNull(application, "application");
        this.application = application;
        return this;
    }
