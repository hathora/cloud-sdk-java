...
public class GetLatestProcessesV2DeprecatedRequestBuilder {
    ...
    public GetLatestProcessesV2DeprecatedRequestBuilder region(java.util.List<com.hathora.cloud_sdk.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.of(region);
        return this;
    }

    public GetLatestProcessesV2DeprecatedRequestBuilder region(java.util.Optional<? extends java.util.List<com.hathora.cloud_sdk.models.shared.Region>> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
                
    public GetLatestProcessesV2DeprecatedRequestBuilder status(java.util.List<com.hathora.cloud_sdk.models.shared.ProcessStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = Optional.of(status);
        return this;
    }

    public GetLatestProcessesV2DeprecatedRequestBuilder status(java.util.Optional<? extends java.util.List<com.hathora.cloud_sdk.models.shared.ProcessStatus>> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
