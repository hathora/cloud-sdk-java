...
public class ListActivePublicLobbiesDeprecatedV1Request {
    ...
    public ListActivePublicLobbiesDeprecatedV1Request withRegion(com.hathora.cloud_sdk.models.shared.Region region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.ofNullable(region);
        return this;
    }

    public ListActivePublicLobbiesDeprecatedV1Request withRegion(Optional<? extends com.hathora.cloud_sdk.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
