...
public class GetBuildInfoResponse implements com.hathora.cloud_sdk.utils.Response {
     ...
     * Ok
     */
    public GetBuildInfoResponse withBuild(com.hathora.cloud_sdk.models.shared.Build build) {
        Utils.checkNotNull(build, "build");
     ...
     * Ok
     */
    public GetBuildInfoResponse withBuild(Optional<? extends com.hathora.cloud_sdk.models.shared.Build> build) {
        Utils.checkNotNull(build, "build");
        this.build = build;
        return this;
    }
