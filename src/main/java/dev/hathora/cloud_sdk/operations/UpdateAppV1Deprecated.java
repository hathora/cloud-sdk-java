...
public class UpdateAppV1Deprecated {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateAppV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAppV1DeprecatedRequest.class, new TypeReference<UpdateAppV1DeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAppV1DeprecatedRequest request) {
        ...
        @Override
        public UpdateAppV1DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withApplication(Utils.unmarshal(response, new TypeReference<Application>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAppV1DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.UpdateAppV1DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAppV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAppV1DeprecatedRequest.class, new TypeReference<UpdateAppV1DeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAppV1DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.UpdateAppV1DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.UpdateAppV1DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.UpdateAppV1DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.UpdateAppV1DeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Application>() {})
                            .thenApply(res::withApplication);
                } else {
