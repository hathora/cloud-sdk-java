...
public class CreateLocalLobbyOperation implements RequestOperation<CreateLocalLobbyRequest, CreateLocalLobbyResponse> {

    private final SDKConfiguration sdkConfiguration;
    private final String baseUrl;
    private final CreateLocalLobbySecurity security;
    private final SecuritySource securitySource;
    private final HTTPClient client;

    public CreateLocalLobbyOperation(
    ...
    public HttpRequest buildRequest(CreateLocalLobbyRequest request) throws Exception {
