...
public class CreateDeploymentV1Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDeploymentV1DeprecatedRequest, CreateDeploymentV1DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDeploymentV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDeploymentV1DeprecatedRequest.class, new TypeReference<CreateDeploymentV1DeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDeploymentV1DeprecatedRequest request) {
        ...
        @Override
        public CreateDeploymentV1DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDeploymentV1DeprecatedResponse.Builder resBuilder =
            ...
            CreateDeploymentV1DeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeploymentV1(Utils.unmarshal(response, new TypeReference<DeploymentV1>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDeploymentV1DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentV1DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDeploymentV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDeploymentV1DeprecatedRequest.class, new TypeReference<CreateDeploymentV1DeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDeploymentV1DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentV1DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentV1DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentV1DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentV1DeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeploymentV1>() {})
                            .thenApply(res::withDeploymentV1);
                } else {
