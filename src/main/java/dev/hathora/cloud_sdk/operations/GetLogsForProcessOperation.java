...
public class GetLogsForProcessOperation implements RequestOperation<GetLogsForProcessRequest, GetLogsForProcessResponse> {
    ...
    public GetLogsForProcessOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLogsForProcessRequest request) throws Exception {
