...
public class GetInactiveRoomsForProcessDeprecated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInactiveRoomsForProcessDeprecatedRequest request) throws Exception {
        ...
        @Override
        public GetInactiveRoomsForProcessDeprecatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<RoomWithoutAllocations> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withClasses(out);
