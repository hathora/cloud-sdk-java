...
public class GetInactiveRoomsForProcessDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInactiveRoomsForProcessDeprecatedRequest, GetInactiveRoomsForProcessDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetInactiveRoomsForProcessDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInactiveRoomsForProcessDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInactiveRoomsForProcessDeprecatedRequest request) {
        ...
        @Override
        public GetInactiveRoomsForProcessDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInactiveRoomsForProcessDeprecatedResponse.Builder resBuilder =
            ...
            GetInactiveRoomsForProcessDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClasses(Utils.unmarshal(response, new TypeReference<List<RoomWithoutAllocations>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInactiveRoomsForProcessDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetInactiveRoomsForProcessDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInactiveRoomsForProcessDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetInactiveRoomsForProcessDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<RoomWithoutAllocations>>() {})
