...
public class CreateAppOperation implements RequestOperation<CreateAppRequest, CreateAppResponse> {
    ...
    public CreateAppOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAppRequest request) throws Exception {
