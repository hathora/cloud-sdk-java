...
public class DestroyRoomDeprecatedOperation implements RequestOperation<DestroyRoomDeprecatedRequest, DestroyRoomDeprecatedResponse> {
    ...
    public DestroyRoomDeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DestroyRoomDeprecatedRequest request) throws Exception {
