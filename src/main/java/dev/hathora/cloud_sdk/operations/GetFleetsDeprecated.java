...
public class GetFleetsDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFleetsDeprecatedRequest, GetFleetsDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFleetsDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetsDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFleetsDeprecatedRequest request) {
        ...
        @Override
        public GetFleetsDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFleetsDeprecatedResponse.Builder resBuilder =
            ...
            GetFleetsDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFleetsPage(Utils.unmarshal(response, new TypeReference<FleetsPage>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFleetsDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetFleetsDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFleetsDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetsDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFleetsDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetFleetsDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetFleetsDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetFleetsDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetFleetsDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FleetsPage>() {})
                            .thenApply(res::withFleetsPage);
                } else {
