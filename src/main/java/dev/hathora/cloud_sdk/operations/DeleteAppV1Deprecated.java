...
public class DeleteAppV1Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteAppV1DeprecatedRequest, DeleteAppV1DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteAppV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAppV1DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteAppV1DeprecatedRequest request) {
        ...
        @Override
        public DeleteAppV1DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteAppV1DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.DeleteAppV1DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteAppV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAppV1DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteAppV1DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.DeleteAppV1DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.DeleteAppV1DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.DeleteAppV1DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.DeleteAppV1DeprecatedResponse res = resBuilder.build();
