...
public class CreateDeployment {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDeploymentRequest, CreateDeploymentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDeploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDeploymentRequest.class, new TypeReference<CreateDeploymentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDeploymentRequest request) {
        ...
        @Override
        public CreateDeploymentResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDeploymentRequest, dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDeploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDeploymentRequest.class, new TypeReference<CreateDeploymentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDeploymentRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateDeploymentResponse res = resBuilder.build();
