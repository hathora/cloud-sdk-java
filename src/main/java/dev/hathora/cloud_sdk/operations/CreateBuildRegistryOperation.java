...
public class CreateBuildRegistryOperation implements RequestOperation<CreateBuildRegistryRequest, CreateBuildRegistryResponse> {
    ...
    public CreateBuildRegistryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateBuildRegistryRequest request) throws Exception {
