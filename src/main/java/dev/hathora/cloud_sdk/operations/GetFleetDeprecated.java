...
public class GetFleetDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFleetDeprecatedRequest, GetFleetDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFleetDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFleetDeprecatedRequest request) {
        ...
        @Override
        public GetFleetDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFleetDeprecatedResponse.Builder resBuilder =
            ...
            GetFleetDeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFleetDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetFleetDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFleetDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFleetDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetFleetDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetFleetDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetFleetDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetFleetDeprecatedResponse res = resBuilder.build();
