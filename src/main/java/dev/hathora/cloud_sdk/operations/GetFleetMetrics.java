...
public class GetFleetMetrics {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFleetMetricsRequest request) throws Exception {
        ...
        @Override
        public GetFleetMetricsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    FleetMetricsData out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFleetMetricsData(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
