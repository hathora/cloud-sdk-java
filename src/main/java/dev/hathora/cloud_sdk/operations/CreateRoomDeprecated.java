...
public class CreateRoomDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRoomDeprecatedRequest, CreateRoomDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRoomDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRoomDeprecatedRequest.class, new TypeReference<CreateRoomDeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRoomDeprecatedRequest request) {
        ...
        @Override
        public CreateRoomDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRoomDeprecatedResponse.Builder resBuilder =
            ...
            CreateRoomDeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRoomDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.CreateRoomDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRoomDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRoomDeprecatedRequest.class, new TypeReference<CreateRoomDeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRoomDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateRoomDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateRoomDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateRoomDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateRoomDeprecatedResponse res = resBuilder.build();
