...
public class CreateBuild {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateBuildRequest, CreateBuildResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateBuildRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateBuildRequest.class, new TypeReference<CreateBuildRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateBuildRequest request) {
        ...
        @Override
        public CreateBuildResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateBuildResponse.Builder resBuilder =
                    CreateBuildResponse
                            .builder()
            ...
            CreateBuildResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreatedBuildV3WithMultipartUrls(Utils.unmarshal(response, new TypeReference<CreatedBuildV3WithMultipartUrls>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateBuildRequest, dev.hathora.cloud_sdk.models.operations.async.CreateBuildResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateBuildRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateBuildRequest.class, new TypeReference<CreateBuildRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateBuildRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateBuildResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateBuildResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateBuildResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateBuildResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreatedBuildV3WithMultipartUrls>() {})
                            .thenApply(res::withCreatedBuildV3WithMultipartUrls);
                } else {
