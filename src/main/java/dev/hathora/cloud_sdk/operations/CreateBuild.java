...
public class CreateBuild {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateBuildRequest request) throws Exception {
        ...
        @Override
        public CreateBuildResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreatedBuildV3WithMultipartUrls out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreatedBuildV3WithMultipartUrls(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
