...
public class GetDeployments {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDeploymentsRequest, GetDeploymentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDeploymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeploymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeploymentsRequest request) {
        ...
        @Override
        public GetDeploymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDeploymentsResponse.Builder resBuilder =
            ...
            GetDeploymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeploymentsV3Page(Utils.unmarshal(response, new TypeReference<DeploymentsV3Page>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDeploymentsRequest, dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDeploymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeploymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDeploymentsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeploymentsV3Page>() {})
                            .thenApply(res::withDeploymentsV3Page);
                } else {
