...
public class GetDeployments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeploymentsRequest request) throws Exception {
        ...
        @Override
        public GetDeploymentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeploymentsV3Page out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeploymentsV3Page(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
