...
public class CreateLobbyOperation implements RequestOperation<CreateLobbyRequest, CreateLobbyResponse> {

    private final SDKConfiguration sdkConfiguration;
    private final String baseUrl;
    private final CreateLobbySecurity security;
    ...
    public HttpRequest buildRequest(CreateLobbyRequest request) throws Exception {
