...
public class GetFleets {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFleetsRequest request) throws Exception {
        ...
        @Override
        public GetFleetsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    FleetsPage out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFleetsPage(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
