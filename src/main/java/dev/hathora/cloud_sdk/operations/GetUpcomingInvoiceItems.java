...
public class GetUpcomingInvoiceItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUpcomingInvoiceItemsRequest, GetUpcomingInvoiceItemsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUpcomingInvoiceItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUpcomingInvoiceItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUpcomingInvoiceItemsRequest request) {
        ...
        @Override
        public GetUpcomingInvoiceItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUpcomingInvoiceItemsResponse.Builder resBuilder =
            ...
            GetUpcomingInvoiceItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInvoiceItemPage(Utils.unmarshal(response, new TypeReference<InvoiceItemPage>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUpcomingInvoiceItemsRequest, dev.hathora.cloud_sdk.models.operations.async.GetUpcomingInvoiceItemsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUpcomingInvoiceItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUpcomingInvoiceItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUpcomingInvoiceItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetUpcomingInvoiceItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetUpcomingInvoiceItemsResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetUpcomingInvoiceItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetUpcomingInvoiceItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InvoiceItemPage>() {})
                            .thenApply(res::withInvoiceItemPage);
                } else {
