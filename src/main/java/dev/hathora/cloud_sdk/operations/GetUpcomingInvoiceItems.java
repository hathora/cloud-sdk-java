...
public class GetUpcomingInvoiceItems {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUpcomingInvoiceItemsRequest request) throws Exception {
        ...
        @Override
        public GetUpcomingInvoiceItemsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    InvoiceItemPage out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInvoiceItemPage(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
