...
public class UpdateFleetOperation implements RequestOperation<UpdateFleetRequest, UpdateFleetResponse> {
    ...
    public UpdateFleetOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateFleetRequest request) throws Exception {
