...
public class CreateBuildV2Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateBuildV2DeprecatedRequest, CreateBuildV2DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateBuildV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateBuildV2DeprecatedRequest.class, new TypeReference<CreateBuildV2DeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateBuildV2DeprecatedRequest request) {
        ...
        @Override
        public CreateBuildV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateBuildV2DeprecatedResponse.Builder resBuilder =
            ...
            CreateBuildV2DeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateBuildV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.CreateBuildV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateBuildV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateBuildV2DeprecatedRequest.class, new TypeReference<CreateBuildV2DeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateBuildV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateBuildV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateBuildV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateBuildV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateBuildV2DeprecatedResponse res = resBuilder.build();
