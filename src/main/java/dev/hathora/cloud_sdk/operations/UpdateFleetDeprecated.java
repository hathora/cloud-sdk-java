...
public class UpdateFleetDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateFleetDeprecatedRequest, UpdateFleetDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateFleetDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateFleetDeprecatedRequest.class, new TypeReference<UpdateFleetDeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateFleetDeprecatedRequest request) {
        ...
        @Override
        public UpdateFleetDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateFleetDeprecatedResponse.Builder resBuilder =
            ...
            UpdateFleetDeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateFleetDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.UpdateFleetDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateFleetDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateFleetDeprecatedRequest.class, new TypeReference<UpdateFleetDeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateFleetDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.UpdateFleetDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.UpdateFleetDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.UpdateFleetDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.UpdateFleetDeprecatedResponse res = resBuilder.build();
