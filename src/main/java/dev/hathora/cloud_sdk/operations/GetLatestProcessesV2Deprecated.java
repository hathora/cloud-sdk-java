...
public class GetLatestProcessesV2Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLatestProcessesV2DeprecatedRequest, GetLatestProcessesV2DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLatestProcessesV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLatestProcessesV2DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLatestProcessesV2DeprecatedRequest request) {
        ...
        @Override
        public GetLatestProcessesV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClasses(Utils.unmarshal(response, new TypeReference<List<ProcessV2>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLatestProcessesV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLatestProcessesV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLatestProcessesV2DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLatestProcessesV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesV2DeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ProcessV2>>() {})
