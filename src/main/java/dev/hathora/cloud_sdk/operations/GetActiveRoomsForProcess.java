...
public class GetActiveRoomsForProcess {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetActiveRoomsForProcessRequest, GetActiveRoomsForProcessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetActiveRoomsForProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetActiveRoomsForProcessRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetActiveRoomsForProcessRequest request) {
        ...
        @Override
        public GetActiveRoomsForProcessResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetActiveRoomsForProcessResponse.Builder resBuilder =
            ...
            GetActiveRoomsForProcessResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetActiveRoomsForProcessRequest, dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetActiveRoomsForProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetActiveRoomsForProcessRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetActiveRoomsForProcessRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessResponse res = resBuilder.build();
