...
public class GetFleetRegionMetricsDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFleetRegionMetricsDeprecatedRequest, GetFleetRegionMetricsDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFleetRegionMetricsDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetRegionMetricsDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFleetRegionMetricsDeprecatedRequest request) {
        ...
        @Override
        public GetFleetRegionMetricsDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFleetRegionMetricsDeprecatedResponse.Builder resBuilder =
            ...
            GetFleetRegionMetricsDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFleetMetricsData(Utils.unmarshal(response, new TypeReference<FleetMetricsData>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFleetRegionMetricsDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFleetRegionMetricsDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetRegionMetricsDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFleetRegionMetricsDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FleetMetricsData>() {})
                            .thenApply(res::withFleetMetricsData);
                } else {
