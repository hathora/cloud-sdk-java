...
public class GetRoomInfoDeprecated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRoomInfoDeprecatedRequest request) {
        ...
        @Override
        public GetRoomInfoDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRoom(Utils.unmarshal(response, new TypeReference<Room>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetRoomInfoDeprecatedResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Room>() {})
                            .thenApply(res::withRoom);
                } else {
