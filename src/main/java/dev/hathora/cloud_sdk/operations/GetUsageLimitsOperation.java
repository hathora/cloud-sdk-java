...
public class GetUsageLimitsOperation implements RequestOperation<GetUsageLimitsRequest, GetUsageLimitsResponse> {
    ...
    public GetUsageLimitsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUsageLimitsRequest request) throws Exception {
