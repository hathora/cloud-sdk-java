...
public class RescindInviteOperation implements RequestOperation<RescindInviteRequest, RescindInviteResponse> {
    ...
    public RescindInviteOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RescindInviteRequest request) throws Exception {
