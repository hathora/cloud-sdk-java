...
public class GetStoppedProcessesOperation implements RequestOperation<GetStoppedProcessesRequest, GetStoppedProcessesResponse> {
    ...
    public GetStoppedProcessesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetStoppedProcessesRequest request) throws Exception {
