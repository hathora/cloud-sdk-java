...
public class GetProcessInfoV2Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProcessInfoV2DeprecatedRequest, GetProcessInfoV2DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetProcessInfoV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessInfoV2DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProcessInfoV2DeprecatedRequest request) {
        ...
        @Override
        public GetProcessInfoV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetProcessInfoV2DeprecatedResponse.Builder resBuilder =
            ...
            GetProcessInfoV2DeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProcessInfoV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetProcessInfoV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessInfoV2DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProcessInfoV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoV2DeprecatedResponse res = resBuilder.build();
