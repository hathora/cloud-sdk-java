...
public class ListActivePublicLobbiesDeprecatedV1 {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListActivePublicLobbiesDeprecatedV1Request request) throws Exception {
        ...
        @Override
        public ListActivePublicLobbiesDeprecatedV1Response handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Lobby> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withClasses(out);
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListActivePublicLobbiesDeprecatedV1Request request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "404", "422", "429", "4XX", "5XX")) {
