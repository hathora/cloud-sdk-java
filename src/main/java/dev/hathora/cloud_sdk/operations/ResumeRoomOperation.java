...
public class ResumeRoomOperation implements RequestOperation<ResumeRoomRequest, ResumeRoomResponse> {
    ...
    public ResumeRoomOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ResumeRoomRequest request) throws Exception {
