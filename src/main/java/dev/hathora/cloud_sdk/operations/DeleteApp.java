...
public class DeleteApp {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteAppRequest, DeleteAppResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAppRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteAppRequest request) {
        ...
        @Override
        public DeleteAppResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteAppResponse.Builder resBuilder =
                    DeleteAppResponse
                            .builder()
            ...
            DeleteAppResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteAppRequest, dev.hathora.cloud_sdk.models.operations.async.DeleteAppResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAppRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteAppRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.DeleteAppResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.DeleteAppResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.DeleteAppResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.DeleteAppResponse res = resBuilder.build();
