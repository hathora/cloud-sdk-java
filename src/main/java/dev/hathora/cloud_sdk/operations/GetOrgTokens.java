...
public class GetOrgTokens {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrgTokensRequest, GetOrgTokensResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetOrgTokensRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrgTokensRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrgTokensRequest request) {
        ...
        @Override
        public GetOrgTokensResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListOrgTokens(Utils.unmarshal(response, new TypeReference<ListOrgTokens>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetOrgTokensRequest, dev.hathora.cloud_sdk.models.operations.async.GetOrgTokensResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetOrgTokensRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrgTokensRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetOrgTokensRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetOrgTokensResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetOrgTokensResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetOrgTokensResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetOrgTokensResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListOrgTokens>() {})
                            .thenApply(res::withListOrgTokens);
                } else {
