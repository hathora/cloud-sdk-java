...
public class GetLatestProcesses {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLatestProcessesRequest, GetLatestProcessesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLatestProcessesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLatestProcessesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLatestProcessesRequest request) {
        ...
        @Override
        public GetLatestProcessesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLatestProcessesResponse.Builder resBuilder =
            ...
            GetLatestProcessesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClasses(Utils.unmarshal(response, new TypeReference<List<ProcessV3>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLatestProcessesRequest, dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLatestProcessesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLatestProcessesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLatestProcessesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetLatestProcessesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ProcessV3>>() {})
