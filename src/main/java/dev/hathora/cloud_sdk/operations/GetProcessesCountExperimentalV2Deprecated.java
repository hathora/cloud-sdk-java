...
public class GetProcessesCountExperimentalV2Deprecated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProcessesCountExperimentalV2DeprecatedRequest request) throws Exception {
        ...
        @Override
        public GetProcessesCountExperimentalV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetProcessesCountExperimentalV2DeprecatedResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
