...
public class GetDeploymentsV2DeprecatedOperation implements RequestOperation<GetDeploymentsV2DeprecatedRequest, GetDeploymentsV2DeprecatedResponse> {
    ...
    public GetDeploymentsV2DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetDeploymentsV2DeprecatedRequest request) throws Exception {
