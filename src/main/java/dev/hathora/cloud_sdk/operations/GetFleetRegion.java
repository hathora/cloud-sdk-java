...
public class GetFleetRegion {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetFleetRegionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetRegionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFleetRegionRequest request) {
        ...
        @Override
        public GetFleetRegionResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFleetRegionRequest, dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFleetRegionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetRegionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFleetRegionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionResponse res = resBuilder.build();
