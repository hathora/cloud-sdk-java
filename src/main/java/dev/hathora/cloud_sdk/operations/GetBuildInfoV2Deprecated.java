...
public class GetBuildInfoV2Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBuildInfoV2DeprecatedRequest, GetBuildInfoV2DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetBuildInfoV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuildInfoV2DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBuildInfoV2DeprecatedRequest request) {
        ...
        @Override
        public GetBuildInfoV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBuildInfoV2DeprecatedResponse.Builder resBuilder =
            ...
            GetBuildInfoV2DeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBuildInfoV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetBuildInfoV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuildInfoV2DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBuildInfoV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoV2DeprecatedResponse res = resBuilder.build();
