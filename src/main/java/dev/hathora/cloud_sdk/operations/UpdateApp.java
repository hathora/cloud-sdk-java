...
public class UpdateApp {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAppRequest, UpdateAppResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAppRequest.class, new TypeReference<UpdateAppRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAppRequest request) {
        ...
        @Override
        public UpdateAppResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAppResponse.Builder resBuilder =
                    UpdateAppResponse
                            .builder()
            ...
            UpdateAppResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAppRequest, dev.hathora.cloud_sdk.models.operations.async.UpdateAppResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAppRequest.class, new TypeReference<UpdateAppRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAppRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.UpdateAppResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.UpdateAppResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.UpdateAppResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.UpdateAppResponse res = resBuilder.build();
