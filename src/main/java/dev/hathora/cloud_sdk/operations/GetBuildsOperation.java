...
public class GetBuildsOperation implements RequestOperation<GetBuildsRequest, GetBuildsResponse> {
    ...
    public GetBuildsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetBuildsRequest request) throws Exception {
