...
public class GetProcessesCountExperimental {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProcessesCountExperimentalRequest, GetProcessesCountExperimentalResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetProcessesCountExperimentalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessesCountExperimentalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProcessesCountExperimentalRequest request) {
        ...
        @Override
        public GetProcessesCountExperimentalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetProcessesCountExperimentalResponse.Builder resBuilder =
            ...
            GetProcessesCountExperimentalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetProcessesCountExperimentalResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProcessesCountExperimentalRequest, dev.hathora.cloud_sdk.models.operations.async.GetProcessesCountExperimentalResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetProcessesCountExperimentalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessesCountExperimentalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProcessesCountExperimentalRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetProcessesCountExperimentalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetProcessesCountExperimentalResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetProcessesCountExperimentalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetProcessesCountExperimentalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetProcessesCountExperimentalResponseBody>() {})
