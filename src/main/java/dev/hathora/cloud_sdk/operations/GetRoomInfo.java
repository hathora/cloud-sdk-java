...
public class GetRoomInfo {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRoomInfoRequest, GetRoomInfoResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRoomInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRoomInfoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRoomInfoRequest request) {
        ...
        @Override
        public GetRoomInfoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRoomInfoResponse.Builder resBuilder =
                    GetRoomInfoResponse
                            .builder()
            ...
            GetRoomInfoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRoomInfoRequest, dev.hathora.cloud_sdk.models.operations.async.GetRoomInfoResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRoomInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRoomInfoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRoomInfoRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetRoomInfoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetRoomInfoResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetRoomInfoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetRoomInfoResponse res = resBuilder.build();
