...
public class GetUpcomingInvoiceTotalOperation implements RequestOperation<GetUpcomingInvoiceTotalRequest, GetUpcomingInvoiceTotalResponse> {
    ...
    public GetUpcomingInvoiceTotalOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUpcomingInvoiceTotalRequest request) throws Exception {
