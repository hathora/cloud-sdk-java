...
public class CreatePublicLobby {

    static abstract class Base {
        final SDKConfiguration sdkConfiguration;
        final String baseUrl;
        final CreatePublicLobbySecurity security;
        final SecuritySource securitySource;
        final HTTPClient client;

        public Base(SDKConfiguration sdkConfiguration, CreatePublicLobbySecurity security) {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePublicLobbyRequest, CreatePublicLobbyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, CreatePublicLobbySecurity security) {
            super(sdkConfiguration, security);
        }

        private HttpRequest onBuildRequest(CreatePublicLobbyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePublicLobbyRequest.class, new TypeReference<CreatePublicLobbyRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePublicLobbyRequest, dev.hathora.cloud_sdk.models.operations.async.CreatePublicLobbyResponse> {

        public Async(SDKConfiguration sdkConfiguration, CreatePublicLobbySecurity security) {
            super(sdkConfiguration, security);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePublicLobbyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePublicLobbyRequest.class, new TypeReference<CreatePublicLobbyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePublicLobbyRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreatePublicLobbyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreatePublicLobbyResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreatePublicLobbyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreatePublicLobbyResponse res = resBuilder.build();
