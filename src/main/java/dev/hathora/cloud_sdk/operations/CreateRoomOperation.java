...
public class CreateRoomOperation implements RequestOperation<CreateRoomRequest, CreateRoomResponse> {
    ...
    public CreateRoomOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateRoomRequest request) throws Exception {
