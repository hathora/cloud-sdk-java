...
public class GetBuildsDeprecatedOperation implements RequestOperation<GetBuildsDeprecatedRequest, GetBuildsDeprecatedResponse> {
    ...
    public GetBuildsDeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetBuildsDeprecatedRequest request) throws Exception {
