...
public class GetUpcomingInvoiceItemsOperation implements RequestOperation<GetUpcomingInvoiceItemsRequest, GetUpcomingInvoiceItemsResponse> {
    ...
    public GetUpcomingInvoiceItemsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUpcomingInvoiceItemsRequest request) throws Exception {
