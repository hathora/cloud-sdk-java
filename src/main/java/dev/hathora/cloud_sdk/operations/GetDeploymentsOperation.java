...
public class GetDeploymentsOperation implements RequestOperation<GetDeploymentsRequest, GetDeploymentsResponse> {
    ...
    public GetDeploymentsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetDeploymentsRequest request) throws Exception {
