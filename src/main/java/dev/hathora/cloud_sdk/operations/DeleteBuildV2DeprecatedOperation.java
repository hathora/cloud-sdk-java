...
public class DeleteBuildV2DeprecatedOperation implements RequestOperation<DeleteBuildV2DeprecatedRequest, DeleteBuildV2DeprecatedResponse> {
    ...
    public DeleteBuildV2DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteBuildV2DeprecatedRequest request) throws Exception {
