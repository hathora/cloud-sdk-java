...
public class GetProcessInfoDeprecatedOperation implements RequestOperation<GetProcessInfoDeprecatedRequest, GetProcessInfoDeprecatedResponse> {
    ...
    public GetProcessInfoDeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetProcessInfoDeprecatedRequest request) throws Exception {
