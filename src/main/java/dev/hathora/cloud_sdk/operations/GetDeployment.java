...
public class GetDeployment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDeploymentRequest, GetDeploymentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDeploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeploymentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeploymentRequest request) {
        ...
        @Override
        public GetDeploymentResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDeploymentRequest, dev.hathora.cloud_sdk.models.operations.async.GetDeploymentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDeploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeploymentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDeploymentRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetDeploymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetDeploymentResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetDeploymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetDeploymentResponse res = resBuilder.build();
