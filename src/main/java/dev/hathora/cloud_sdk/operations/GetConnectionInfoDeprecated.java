...
public class GetConnectionInfoDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetConnectionInfoDeprecatedRequest, GetConnectionInfoDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetConnectionInfoDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetConnectionInfoDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConnectionInfoDeprecatedRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "402", "404", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public GetConnectionInfoDeprecatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetConnectionInfoDeprecatedResponse.Builder resBuilder =
            ...
            GetConnectionInfoDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ConnectionInfo out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnectionInfo(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "402", "404", "429")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetConnectionInfoDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetConnectionInfoDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetConnectionInfoDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetConnectionInfoDeprecatedRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "402", "404", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoDeprecatedResponse res = resBuilder.build();
