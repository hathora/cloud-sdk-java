...
public class GetConnectionInfoDeprecated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConnectionInfoDeprecatedRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "402", "404", "408", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public GetConnectionInfoDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "402", "404", "408", "429")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetConnectionInfoDeprecatedRequest request) {
            return unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "402", "404", "408", "429", "4XX", "500", "5XX")) {
