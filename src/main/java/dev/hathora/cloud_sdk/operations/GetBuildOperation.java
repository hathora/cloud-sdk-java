...
public class GetBuildOperation implements RequestOperation<GetBuildRequest, GetBuildResponse> {
    ...
    public GetBuildOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetBuildRequest request) throws Exception {
