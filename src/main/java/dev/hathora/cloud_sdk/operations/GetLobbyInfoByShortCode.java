...
public class GetLobbyInfoByShortCode {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLobbyInfoByShortCodeRequest, GetLobbyInfoByShortCodeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLobbyInfoByShortCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLobbyInfoByShortCodeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLobbyInfoByShortCodeRequest request) {
        ...
        @Override
        public GetLobbyInfoByShortCodeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLobbyInfoByShortCodeResponse.Builder resBuilder =
            ...
            GetLobbyInfoByShortCodeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLobbyV3(Utils.unmarshal(response, new TypeReference<LobbyV3>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLobbyInfoByShortCodeRequest, dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByShortCodeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLobbyInfoByShortCodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLobbyInfoByShortCodeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLobbyInfoByShortCodeRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByShortCodeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByShortCodeResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByShortCodeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByShortCodeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LobbyV3>() {})
                            .thenApply(res::withLobbyV3);
                } else {
