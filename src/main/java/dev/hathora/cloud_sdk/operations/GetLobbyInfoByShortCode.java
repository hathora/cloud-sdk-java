...
public class GetLobbyInfoByShortCode {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLobbyInfoByShortCodeRequest request) throws Exception {
        ...
        @Override
        public GetLobbyInfoByShortCodeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLobbyInfoByShortCodeRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "404", "429", "4XX", "5XX")) {
