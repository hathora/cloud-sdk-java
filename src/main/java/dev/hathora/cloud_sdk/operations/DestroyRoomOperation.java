...
public class DestroyRoomOperation implements RequestOperation<DestroyRoomRequest, DestroyRoomResponse> {
    ...
    public DestroyRoomOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DestroyRoomRequest request) throws Exception {
