...
public class CreateAppV1Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAppConfig, CreateAppV1DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAppConfig request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateAppConfig>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAppConfig request) {
        ...
        @Override
        public CreateAppV1DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAppV1DeprecatedResponse.Builder resBuilder =
            ...
            CreateAppV1DeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAppConfig, dev.hathora.cloud_sdk.models.operations.async.CreateAppV1DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAppConfig request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateAppConfig>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAppConfig request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateAppV1DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateAppV1DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateAppV1DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateAppV1DeprecatedResponse res = resBuilder.build();
