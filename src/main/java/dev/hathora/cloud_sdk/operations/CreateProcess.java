...
public class CreateProcess {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateProcessRequest, CreateProcessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateProcessRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateProcessRequest request) {
        ...
        @Override
        public CreateProcessResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateProcessResponse.Builder resBuilder =
            ...
            CreateProcessResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProcessV3(Utils.unmarshal(response, new TypeReference<ProcessV3>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateProcessRequest, dev.hathora.cloud_sdk.models.operations.async.CreateProcessResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateProcessRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateProcessRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateProcessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateProcessResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateProcessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateProcessResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProcessV3>() {})
                            .thenApply(res::withProcessV3);
                } else {
