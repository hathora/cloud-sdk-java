...
public class CreateProcess {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateProcessRequest request) throws Exception {
        ...
        @Override
        public CreateProcessResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ProcessV3 out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withProcessV3(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
