...
public class CreateOrgToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateOrgTokenRequest, CreateOrgTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateOrgTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateOrgTokenRequest.class, new TypeReference<CreateOrgTokenRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateOrgTokenRequest request) {
        ...
        @Override
        public CreateOrgTokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreatedOrgToken(Utils.unmarshal(response, new TypeReference<CreatedOrgToken>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateOrgTokenRequest, dev.hathora.cloud_sdk.models.operations.async.CreateOrgTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateOrgTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateOrgTokenRequest.class, new TypeReference<CreateOrgTokenRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateOrgTokenRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateOrgTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateOrgTokenResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateOrgTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateOrgTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreatedOrgToken>() {})
                            .thenApply(res::withCreatedOrgToken);
                } else {
