...
public class CreateBuildDeprecatedOperation implements RequestOperation<CreateBuildDeprecatedRequest, CreateBuildDeprecatedResponse> {
    ...
    public CreateBuildDeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateBuildDeprecatedRequest request) throws Exception {
