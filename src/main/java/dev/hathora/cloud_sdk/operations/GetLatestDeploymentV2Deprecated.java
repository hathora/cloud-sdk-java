...
public class GetLatestDeploymentV2Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLatestDeploymentV2DeprecatedRequest, GetLatestDeploymentV2DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLatestDeploymentV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLatestDeploymentV2DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLatestDeploymentV2DeprecatedRequest request) {
        ...
        @Override
        public GetLatestDeploymentV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLatestDeploymentV2DeprecatedResponse.Builder resBuilder =
            ...
            GetLatestDeploymentV2DeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLatestDeploymentV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLatestDeploymentV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLatestDeploymentV2DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLatestDeploymentV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentV2DeprecatedResponse res = resBuilder.build();
