...
public class GetLatestDeploymentV2Deprecated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLatestDeploymentV2DeprecatedRequest request) throws Exception {
        ...
        @Override
        public GetLatestDeploymentV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeploymentV2 out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDeploymentV2(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
