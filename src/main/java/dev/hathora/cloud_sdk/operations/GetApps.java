...
public class GetApps {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAppsRequest, GetAppsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAppsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAppsRequest request) {
        ...
        @Override
        public GetAppsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAppsResponse.Builder resBuilder =
                    GetAppsResponse
                            .builder()
            ...
            GetAppsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withApplicationsPage(Utils.unmarshal(response, new TypeReference<ApplicationsPage>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAppsRequest, dev.hathora.cloud_sdk.models.operations.async.GetAppsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAppsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAppsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetAppsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetAppsResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetAppsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetAppsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ApplicationsPage>() {})
                            .thenApply(res::withApplicationsPage);
                } else {
