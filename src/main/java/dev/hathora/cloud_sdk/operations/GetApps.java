...
public class GetApps {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAppsRequest request) throws Exception {
        ...
        @Override
        public GetAppsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ApplicationsPage out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withApplicationsPage(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
