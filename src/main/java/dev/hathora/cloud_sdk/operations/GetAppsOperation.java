...
public class GetAppsOperation implements RequestOperation<GetAppsRequest, GetAppsResponse> {
    ...
    public GetAppsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAppsRequest request) throws Exception {
