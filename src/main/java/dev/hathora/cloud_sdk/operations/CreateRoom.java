...
public class CreateRoom {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRoomRequest request) throws Exception {
        ...
        @Override
        public CreateRoomResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RoomConnectionData out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRoomConnectionData(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
