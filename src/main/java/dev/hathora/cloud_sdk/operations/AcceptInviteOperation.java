...
public class AcceptInviteOperation implements RequestOperation<AcceptInviteRequest, AcceptInviteResponse> {
    ...
    public AcceptInviteOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(AcceptInviteRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AcceptInviteRequest request) throws Exception {
    ...
    @Override
    public AcceptInviteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
