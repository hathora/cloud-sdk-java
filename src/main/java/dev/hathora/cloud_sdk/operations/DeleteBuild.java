...
public class DeleteBuild {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(DeleteBuildRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBuildRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteBuildRequest request) {
        ...
        @Override
        public DeleteBuildResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeletedBuild(Utils.unmarshal(response, new TypeReference<DeletedBuild>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteBuildRequest, dev.hathora.cloud_sdk.models.operations.async.DeleteBuildResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteBuildRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBuildRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteBuildRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.DeleteBuildResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.DeleteBuildResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.DeleteBuildResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.DeleteBuildResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeletedBuild>() {})
                            .thenApply(res::withDeletedBuild);
                } else {
