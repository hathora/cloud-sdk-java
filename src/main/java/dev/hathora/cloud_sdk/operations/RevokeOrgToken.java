...
public class RevokeOrgToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<RevokeOrgTokenRequest, RevokeOrgTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RevokeOrgTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeOrgTokenRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RevokeOrgTokenRequest request) {
        ...
        @Override
        public RevokeOrgTokenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RevokeOrgTokenResponse.Builder resBuilder =
            ...
            RevokeOrgTokenResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RevokeOrgTokenRequest, dev.hathora.cloud_sdk.models.operations.async.RevokeOrgTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RevokeOrgTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RevokeOrgTokenRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RevokeOrgTokenRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.RevokeOrgTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.RevokeOrgTokenResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.RevokeOrgTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.RevokeOrgTokenResponse res = resBuilder.build();
