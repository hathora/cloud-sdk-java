...
public class StopProcess {
    ...
    public static class Sync extends Base
            implements RequestOperation<StopProcessRequest, StopProcessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(StopProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopProcessRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StopProcessRequest request) {
        ...
        @Override
        public StopProcessResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StopProcessResponse.Builder resBuilder =
                    StopProcessResponse
                            .builder()
            ...
            StopProcessResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StopProcessRequest, dev.hathora.cloud_sdk.models.operations.async.StopProcessResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(StopProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopProcessRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StopProcessRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.StopProcessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.StopProcessResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.StopProcessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.StopProcessResponse res = resBuilder.build();
