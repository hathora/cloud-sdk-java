...
public class CreateFleetDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateFleetDeprecatedRequest, CreateFleetDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateFleetDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFleetDeprecatedRequest.class, new TypeReference<CreateFleetDeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateFleetDeprecatedRequest request) {
        ...
        @Override
        public CreateFleetDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateFleetDeprecatedResponse.Builder resBuilder =
            ...
            CreateFleetDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFleet(Utils.unmarshal(response, new TypeReference<Fleet>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateFleetDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.CreateFleetDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateFleetDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFleetDeprecatedRequest.class, new TypeReference<CreateFleetDeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateFleetDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateFleetDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateFleetDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateFleetDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateFleetDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Fleet>() {})
                            .thenApply(res::withFleet);
                } else {
