...
public class GetDeploymentInfoV1Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDeploymentInfoV1DeprecatedRequest, GetDeploymentInfoV1DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDeploymentInfoV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeploymentInfoV1DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeploymentInfoV1DeprecatedRequest request) {
        ...
        @Override
        public GetDeploymentInfoV1DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDeploymentInfoV1DeprecatedResponse.Builder resBuilder =
            ...
            GetDeploymentInfoV1DeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDeploymentInfoV1DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetDeploymentInfoV1DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDeploymentInfoV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeploymentInfoV1DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDeploymentInfoV1DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetDeploymentInfoV1DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetDeploymentInfoV1DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetDeploymentInfoV1DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetDeploymentInfoV1DeprecatedResponse res = resBuilder.build();
