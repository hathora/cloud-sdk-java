...
public class ResumeRoom {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResumeRoomRequest request) throws Exception {
        ...
        @Override
        public ResumeRoomResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RoomAllocationData out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRoomAllocationData(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
