...
public class ResumeRoom {
    ...
    public static class Sync extends Base
            implements RequestOperation<ResumeRoomRequest, ResumeRoomResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ResumeRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResumeRoomRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResumeRoomRequest request) {
        ...
        @Override
        public ResumeRoomResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ResumeRoomResponse.Builder resBuilder =
                    ResumeRoomResponse
                            .builder()
            ...
            ResumeRoomResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRoomAllocationData(Utils.unmarshal(response, new TypeReference<RoomAllocationData>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ResumeRoomRequest, dev.hathora.cloud_sdk.models.operations.async.ResumeRoomResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ResumeRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResumeRoomRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ResumeRoomRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.ResumeRoomResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.ResumeRoomResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.ResumeRoomResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.ResumeRoomResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RoomAllocationData>() {})
                            .thenApply(res::withRoomAllocationData);
                } else {
