...
public class InviteUserOperation implements RequestOperation<InviteUserRequest, InviteUserResponse> {
    ...
    public InviteUserOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(InviteUserRequest request) throws Exception {
