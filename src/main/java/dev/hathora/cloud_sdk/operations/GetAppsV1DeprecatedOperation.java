...
public class GetAppsV1DeprecatedOperation implements RequestlessOperation<GetAppsV1DeprecatedResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetAppsV1DeprecatedOperation(SDKConfiguration sdkConfiguration) {
