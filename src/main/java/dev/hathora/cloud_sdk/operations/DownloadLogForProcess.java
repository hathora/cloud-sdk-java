...
public class DownloadLogForProcess {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DownloadLogForProcessRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "404", "408", "410", "429", "4XX", "5XX")) {
        ...
        @Override
        public DownloadLogForProcessResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "404", "408", "410", "429")) {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(DownloadLogForProcessRequest request) {
            return unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "404", "408", "410", "429", "4XX", "5XX")) {
