...
public class DownloadLogForProcess {
    ...
    public static class Sync extends Base
            implements RequestOperation<DownloadLogForProcessRequest, DownloadLogForProcessResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(DownloadLogForProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DownloadLogForProcessRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DownloadLogForProcessRequest, dev.hathora.cloud_sdk.models.operations.async.DownloadLogForProcessResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DownloadLogForProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DownloadLogForProcessRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DownloadLogForProcessRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "404", "410", "429", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.DownloadLogForProcessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.DownloadLogForProcessResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.DownloadLogForProcessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.hathora.cloud_sdk.models.operations.async.DownloadLogForProcessResponse res = resBuilder.build();
