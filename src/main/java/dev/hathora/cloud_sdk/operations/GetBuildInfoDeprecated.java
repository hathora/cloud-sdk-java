...
public class GetBuildInfoDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBuildInfoDeprecatedRequest, GetBuildInfoDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetBuildInfoDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuildInfoDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBuildInfoDeprecatedRequest request) {
        ...
        @Override
        public GetBuildInfoDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBuildInfoDeprecatedResponse.Builder resBuilder =
            ...
            GetBuildInfoDeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBuildInfoDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetBuildInfoDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuildInfoDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBuildInfoDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetBuildInfoDeprecatedResponse res = resBuilder.build();
