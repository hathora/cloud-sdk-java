...
public class GetBuilds {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBuildsRequest request) throws Exception {
        ...
        @Override
        public GetBuildsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BuildsV3Page out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBuildsV3Page(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
