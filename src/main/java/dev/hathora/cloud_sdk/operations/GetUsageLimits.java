...
public class GetUsageLimits {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUsageLimitsRequest request) throws Exception {
        ...
        @Override
        public GetUsageLimitsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UsageLimits out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUsageLimits(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
