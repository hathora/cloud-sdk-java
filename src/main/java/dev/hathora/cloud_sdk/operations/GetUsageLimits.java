...
public class GetUsageLimits {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUsageLimitsRequest, GetUsageLimitsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUsageLimitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUsageLimitsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUsageLimitsRequest request) {
        ...
        @Override
        public GetUsageLimitsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUsageLimitsResponse.Builder resBuilder =
            ...
            GetUsageLimitsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUsageLimits(Utils.unmarshal(response, new TypeReference<UsageLimits>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUsageLimitsRequest, dev.hathora.cloud_sdk.models.operations.async.GetUsageLimitsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUsageLimitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUsageLimitsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUsageLimitsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetUsageLimitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetUsageLimitsResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetUsageLimitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetUsageLimitsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UsageLimits>() {})
                            .thenApply(res::withUsageLimits);
                } else {
