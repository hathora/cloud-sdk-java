...
public class GetAppInfoV1DeprecatedOperation implements RequestOperation<GetAppInfoV1DeprecatedRequest, GetAppInfoV1DeprecatedResponse> {
    ...
    public GetAppInfoV1DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAppInfoV1DeprecatedRequest request) throws Exception {
