...
public class GetInactiveRoomsForProcess {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInactiveRoomsForProcessRequest, GetInactiveRoomsForProcessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetInactiveRoomsForProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInactiveRoomsForProcessRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInactiveRoomsForProcessRequest request) {
        ...
        @Override
        public GetInactiveRoomsForProcessResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInactiveRoomsForProcessResponse.Builder resBuilder =
            ...
            GetInactiveRoomsForProcessResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInactiveRoomsForProcessRequest, dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetInactiveRoomsForProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInactiveRoomsForProcessRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetInactiveRoomsForProcessRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetInactiveRoomsForProcessResponse res = resBuilder.build();
