...
public class GetBalanceOperation implements RequestOperation<GetBalanceRequest, GetBalanceResponse> {
    ...
    public GetBalanceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetBalanceRequest request) throws Exception {
