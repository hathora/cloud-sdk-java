...
public class UpdateUserInviteOperation implements RequestOperation<UpdateUserInviteRequest, UpdateUserInviteResponse> {
    ...
    public UpdateUserInviteOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateUserInviteRequest request) throws Exception {
