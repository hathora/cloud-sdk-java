...
public class GetConnectionInfo {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetConnectionInfoRequest, GetConnectionInfoResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetConnectionInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetConnectionInfoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConnectionInfoRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "402", "404", "408", "422", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public GetConnectionInfoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetConnectionInfoResponse.Builder resBuilder =
            ...
            GetConnectionInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnectionInfoV2(Utils.unmarshal(response, new TypeReference<ConnectionInfoV2>() {}));
                } else {
                    throw SDKError.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "402", "404", "408", "422", "429")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetConnectionInfoRequest, dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetConnectionInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetConnectionInfoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetConnectionInfoRequest request) {
            return unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "402", "404", "408", "422", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetConnectionInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ConnectionInfoV2>() {})
                            .thenApply(res::withConnectionInfoV2);
                } else {
