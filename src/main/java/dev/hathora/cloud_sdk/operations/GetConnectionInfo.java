...
public class GetConnectionInfo {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConnectionInfoRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "402", "404", "422", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public GetConnectionInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ConnectionInfoV2 out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnectionInfoV2(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "402", "404", "422", "429")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetConnectionInfoRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "402", "404", "422", "429", "4XX", "500", "5XX")) {
