...
public class GetBuildInfoV2DeprecatedOperation implements RequestOperation<GetBuildInfoV2DeprecatedRequest, GetBuildInfoV2DeprecatedResponse> {
    ...
    public GetBuildInfoV2DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetBuildInfoV2DeprecatedRequest request) throws Exception {
