...
public class ListActivePublicLobbiesDeprecatedV2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListActivePublicLobbiesDeprecatedV2Request, ListActivePublicLobbiesDeprecatedV2Response> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListActivePublicLobbiesDeprecatedV2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListActivePublicLobbiesDeprecatedV2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListActivePublicLobbiesDeprecatedV2Request request) {
        ...
        @Override
        public ListActivePublicLobbiesDeprecatedV2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListActivePublicLobbiesDeprecatedV2Response.Builder resBuilder =
            ...
            ListActivePublicLobbiesDeprecatedV2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListActivePublicLobbiesDeprecatedV2Request, dev.hathora.cloud_sdk.models.operations.async.ListActivePublicLobbiesDeprecatedV2Response> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListActivePublicLobbiesDeprecatedV2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListActivePublicLobbiesDeprecatedV2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListActivePublicLobbiesDeprecatedV2Request request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.ListActivePublicLobbiesDeprecatedV2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.ListActivePublicLobbiesDeprecatedV2Response.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.ListActivePublicLobbiesDeprecatedV2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.ListActivePublicLobbiesDeprecatedV2Response res = resBuilder.build();
