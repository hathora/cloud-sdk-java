...
public class GetPingServiceEndpointsDeprecated {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetPingServiceEndpointsDeprecatedResponse> {
        ...
        @Override
        public GetPingServiceEndpointsDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPingServiceEndpointsDeprecatedResponse.Builder resBuilder =
            ...
            GetPingServiceEndpointsDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPingEndpoints(Utils.unmarshal(response, new TypeReference<List<PingEndpoints>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsDeprecatedResponse> {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PingEndpoints>>() {})
                            .thenApply(res::withPingEndpoints);
                } else {
