...
public class CreatePrivateLobbyDeprecated {
    ...
    public static class Async extends Base
        ...
        public Async(SDKConfiguration sdkConfiguration, CreatePrivateLobbyDeprecatedSecurity security) {
            super(sdkConfiguration, security);
        }
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePrivateLobbyDeprecatedRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "402", "404", "422", "429", "4XX", "500", "5XX")) {
