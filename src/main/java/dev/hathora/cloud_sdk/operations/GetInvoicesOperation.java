...
public class GetInvoicesOperation implements RequestOperation<GetInvoicesRequest, GetInvoicesResponse> {
    ...
    public GetInvoicesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetInvoicesRequest request) throws Exception {
