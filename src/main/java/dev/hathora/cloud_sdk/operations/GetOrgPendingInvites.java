...
public class GetOrgPendingInvites {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrgPendingInvitesRequest request) {
        ...
        @Override
        public GetOrgPendingInvitesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPendingOrgInvitesPage(Utils.unmarshal(response, new TypeReference<PendingOrgInvitesPage>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetOrgPendingInvitesResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PendingOrgInvitesPage>() {})
                            .thenApply(res::withPendingOrgInvitesPage);
                } else {
