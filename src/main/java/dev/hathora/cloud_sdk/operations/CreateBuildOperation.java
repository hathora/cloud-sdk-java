...
public class CreateBuildOperation implements RequestOperation<CreateBuildRequest, CreateBuildResponse> {
    ...
    public CreateBuildOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateBuildRequest request) throws Exception {
