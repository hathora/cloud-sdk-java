...
public class GetOrgMembers {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrgMembersRequest, GetOrgMembersResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetOrgMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrgMembersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrgMembersRequest request) {
        ...
        @Override
        public GetOrgMembersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOrgMembersResponse.Builder resBuilder =
            ...
            GetOrgMembersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrgMembersPage(Utils.unmarshal(response, new TypeReference<OrgMembersPage>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetOrgMembersRequest, dev.hathora.cloud_sdk.models.operations.async.GetOrgMembersResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetOrgMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrgMembersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetOrgMembersRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetOrgMembersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetOrgMembersResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetOrgMembersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetOrgMembersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<OrgMembersPage>() {})
                            .thenApply(res::withOrgMembersPage);
                } else {
