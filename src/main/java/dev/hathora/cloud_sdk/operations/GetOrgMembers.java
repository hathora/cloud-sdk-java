...
public class GetOrgMembers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrgMembersRequest request) throws Exception {
        ...
        @Override
        public GetOrgMembersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    OrgMembersPage out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrgMembersPage(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
