...
public class CreateFleet {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateFleetRequest, CreateFleetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateFleetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFleetRequest.class, new TypeReference<CreateFleetRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateFleetRequest request) {
        ...
        @Override
        public CreateFleetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateFleetResponse.Builder resBuilder =
                    CreateFleetResponse
                            .builder()
            ...
            CreateFleetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFleetV2(Utils.unmarshal(response, new TypeReference<FleetV2>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateFleetRequest, dev.hathora.cloud_sdk.models.operations.async.CreateFleetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateFleetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFleetRequest.class, new TypeReference<CreateFleetRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateFleetRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateFleetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateFleetResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateFleetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateFleetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FleetV2>() {})
                            .thenApply(res::withFleetV2);
                } else {
