...
public class GetActiveRoomsForProcessDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetActiveRoomsForProcessDeprecatedRequest, GetActiveRoomsForProcessDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetActiveRoomsForProcessDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetActiveRoomsForProcessDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetActiveRoomsForProcessDeprecatedRequest request) {
        ...
        @Override
        public GetActiveRoomsForProcessDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetActiveRoomsForProcessDeprecatedResponse.Builder resBuilder =
            ...
            GetActiveRoomsForProcessDeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetActiveRoomsForProcessDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetActiveRoomsForProcessDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetActiveRoomsForProcessDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetActiveRoomsForProcessDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetActiveRoomsForProcessDeprecatedResponse res = resBuilder.build();
