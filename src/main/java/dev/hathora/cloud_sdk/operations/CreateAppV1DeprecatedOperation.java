...
public class CreateAppV1DeprecatedOperation implements RequestOperation<AppConfig, CreateAppV1DeprecatedResponse> {
    ...
    public CreateAppV1DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(AppConfig request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(AppConfig request) throws Exception {
        HttpRequest r = buildRequest(request);
        HttpResponse<InputStream> httpRes;
        try {
            httpRes = client.send(r);
            if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "422", "429", "4XX", "500", "5XX")) {
