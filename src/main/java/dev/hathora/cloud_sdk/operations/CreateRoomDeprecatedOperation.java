...
public class CreateRoomDeprecatedOperation implements RequestOperation<CreateRoomDeprecatedRequest, CreateRoomDeprecatedResponse> {
    ...
    public CreateRoomDeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateRoomDeprecatedRequest request) throws Exception {
