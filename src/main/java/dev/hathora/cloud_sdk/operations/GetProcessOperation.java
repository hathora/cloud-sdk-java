...
public class GetProcessOperation implements RequestOperation<GetProcessRequest, GetProcessResponse> {
    ...
    public GetProcessOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetProcessRequest request) throws Exception {
