...
public class CreateWithMultipartUploadsV2Deprecated {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateWithMultipartUploadsV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateWithMultipartUploadsV2DeprecatedRequest.class, new TypeReference<CreateWithMultipartUploadsV2DeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateWithMultipartUploadsV2DeprecatedRequest request) {
        ...
        @Override
        public CreateWithMultipartUploadsV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBuildWithMultipartUrls(Utils.unmarshal(response, new TypeReference<BuildWithMultipartUrls>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateWithMultipartUploadsV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.CreateWithMultipartUploadsV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateWithMultipartUploadsV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateWithMultipartUploadsV2DeprecatedRequest.class, new TypeReference<CreateWithMultipartUploadsV2DeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateWithMultipartUploadsV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateWithMultipartUploadsV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateWithMultipartUploadsV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateWithMultipartUploadsV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateWithMultipartUploadsV2DeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BuildWithMultipartUrls>() {})
                            .thenApply(res::withBuildWithMultipartUrls);
                } else {
