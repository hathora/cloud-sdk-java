...
public class GetDeploymentsV1Deprecated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeploymentsV1DeprecatedRequest request) throws Exception {
        ...
        @Override
        public GetDeploymentsV1DeprecatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<DeploymentV1> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withClasses(out);
