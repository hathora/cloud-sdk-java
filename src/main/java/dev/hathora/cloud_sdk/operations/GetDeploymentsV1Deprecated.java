...
public class GetDeploymentsV1Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDeploymentsV1DeprecatedRequest, GetDeploymentsV1DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDeploymentsV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeploymentsV1DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeploymentsV1DeprecatedRequest request) {
        ...
        @Override
        public GetDeploymentsV1DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDeploymentsV1DeprecatedResponse.Builder resBuilder =
            ...
            GetDeploymentsV1DeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClasses(Utils.unmarshal(response, new TypeReference<List<DeploymentV1>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDeploymentsV1DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsV1DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDeploymentsV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeploymentsV1DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDeploymentsV1DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsV1DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsV1DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsV1DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetDeploymentsV1DeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<DeploymentV1>>() {})
