...
public class GetLobbyInfoByShortCodeOperation implements RequestOperation<GetLobbyInfoByShortCodeRequest, GetLobbyInfoByShortCodeResponse> {
    ...
    public GetLobbyInfoByShortCodeOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLobbyInfoByShortCodeRequest request) throws Exception {
