...
public class CreateProcessOperation implements RequestOperation<CreateProcessRequest, CreateProcessResponse> {
    ...
    public CreateProcessOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateProcessRequest request) throws Exception {
