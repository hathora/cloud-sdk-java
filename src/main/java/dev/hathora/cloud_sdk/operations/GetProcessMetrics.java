...
public class GetProcessMetrics {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProcessMetricsRequest, GetProcessMetricsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetProcessMetricsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessMetricsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProcessMetricsRequest request) {
        ...
        @Override
        public GetProcessMetricsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProcessMetricsData(Utils.unmarshal(response, new TypeReference<ProcessMetricsData>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProcessMetricsRequest, dev.hathora.cloud_sdk.models.operations.async.GetProcessMetricsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetProcessMetricsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessMetricsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProcessMetricsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetProcessMetricsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetProcessMetricsResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetProcessMetricsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetProcessMetricsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProcessMetricsData>() {})
                            .thenApply(res::withProcessMetricsData);
                } else {
