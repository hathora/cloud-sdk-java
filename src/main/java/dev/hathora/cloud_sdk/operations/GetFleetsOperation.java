...
public class GetFleetsOperation implements RequestOperation<GetFleetsRequest, GetFleetsResponse> {
    ...
    public GetFleetsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetFleetsRequest request) throws Exception {
