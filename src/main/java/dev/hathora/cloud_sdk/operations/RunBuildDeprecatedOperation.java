...
public class RunBuildDeprecatedOperation implements RequestOperation<RunBuildDeprecatedRequest, RunBuildDeprecatedResponse> {
    ...
    public RunBuildDeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RunBuildDeprecatedRequest request) throws Exception {
