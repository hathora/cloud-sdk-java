...
public class UpdateAppOperation implements RequestOperation<UpdateAppRequest, UpdateAppResponse> {
    ...
    public UpdateAppOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAppRequest request) throws Exception {
