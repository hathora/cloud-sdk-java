...
public class SetLobbyStateOperation implements RequestOperation<SetLobbyStateRequest, SetLobbyStateResponse> {
    ...
    public SetLobbyStateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(SetLobbyStateRequest request) throws Exception {
