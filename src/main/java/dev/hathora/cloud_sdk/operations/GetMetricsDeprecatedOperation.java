...
public class GetMetricsDeprecatedOperation implements RequestOperation<GetMetricsDeprecatedRequest, GetMetricsDeprecatedResponse> {
    ...
    public GetMetricsDeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetMetricsDeprecatedRequest request) throws Exception {
