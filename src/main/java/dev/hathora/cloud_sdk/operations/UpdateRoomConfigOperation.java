...
public class UpdateRoomConfigOperation implements RequestOperation<UpdateRoomConfigRequest, UpdateRoomConfigResponse> {
    ...
    public UpdateRoomConfigOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateRoomConfigRequest request) throws Exception {
