...
public class GetRunningProcessesOperation implements RequestOperation<GetRunningProcessesRequest, GetRunningProcessesResponse> {
    ...
    public GetRunningProcessesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetRunningProcessesRequest request) throws Exception {
