...
public class GetProcessInfoDeprecated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProcessInfoDeprecatedRequest request) throws Exception {
        ...
        @Override
        public GetProcessInfoDeprecatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Process out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withProcess(out);
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProcessInfoDeprecatedRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "401", "404", "429", "4XX", "500", "5XX")) {
