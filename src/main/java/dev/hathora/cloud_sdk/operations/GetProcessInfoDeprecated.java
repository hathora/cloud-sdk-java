...
public class GetProcessInfoDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProcessInfoDeprecatedRequest, GetProcessInfoDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetProcessInfoDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessInfoDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProcessInfoDeprecatedRequest request) {
        ...
        @Override
        public GetProcessInfoDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetProcessInfoDeprecatedResponse.Builder resBuilder =
            ...
            GetProcessInfoDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProcess(Utils.unmarshal(response, new TypeReference<Process>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProcessInfoDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetProcessInfoDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessInfoDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProcessInfoDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetProcessInfoDeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Process>() {})
                            .thenApply(res::withProcess);
                } else {
