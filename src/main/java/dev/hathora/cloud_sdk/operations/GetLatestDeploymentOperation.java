...
public class GetLatestDeploymentOperation implements RequestOperation<GetLatestDeploymentRequest, GetLatestDeploymentResponse> {
    ...
    public GetLatestDeploymentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLatestDeploymentRequest request) throws Exception {
