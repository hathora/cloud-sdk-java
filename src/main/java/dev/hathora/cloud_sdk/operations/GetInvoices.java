...
public class GetInvoices {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInvoicesRequest, GetInvoicesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetInvoicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInvoicesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInvoicesRequest request) {
        ...
        @Override
        public GetInvoicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInvoicesResponse.Builder resBuilder =
                    GetInvoicesResponse
                            .builder()
            ...
            GetInvoicesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClasses(Utils.unmarshal(response, new TypeReference<List<Invoice>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInvoicesRequest, dev.hathora.cloud_sdk.models.operations.async.GetInvoicesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetInvoicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInvoicesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetInvoicesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetInvoicesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetInvoicesResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetInvoicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetInvoicesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<Invoice>>() {})
