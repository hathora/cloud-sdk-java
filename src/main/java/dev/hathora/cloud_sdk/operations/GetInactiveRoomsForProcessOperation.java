...
public class GetInactiveRoomsForProcessOperation implements RequestOperation<GetInactiveRoomsForProcessRequest, GetInactiveRoomsForProcessResponse> {
    ...
    public GetInactiveRoomsForProcessOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetInactiveRoomsForProcessRequest request) throws Exception {
