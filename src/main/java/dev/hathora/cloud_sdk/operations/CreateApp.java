...
public class CreateApp {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAppRequest, CreateAppResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAppRequest.class, new TypeReference<CreateAppRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAppRequest request) {
        ...
        @Override
        public CreateAppResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAppResponse.Builder resBuilder =
                    CreateAppResponse
                            .builder()
            ...
            CreateAppResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAppRequest, dev.hathora.cloud_sdk.models.operations.async.CreateAppResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAppRequest.class, new TypeReference<CreateAppRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAppRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.CreateAppResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.CreateAppResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.CreateAppResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.CreateAppResponse res = resBuilder.build();
