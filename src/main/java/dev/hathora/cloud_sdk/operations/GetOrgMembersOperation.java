...
public class GetOrgMembersOperation implements RequestOperation<GetOrgMembersRequest, GetOrgMembersResponse> {
    ...
    public GetOrgMembersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetOrgMembersRequest request) throws Exception {
