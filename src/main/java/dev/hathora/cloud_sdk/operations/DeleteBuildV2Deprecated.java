...
public class DeleteBuildV2Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteBuildV2DeprecatedRequest, DeleteBuildV2DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteBuildV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBuildV2DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteBuildV2DeprecatedRequest request) {
        ...
        @Override
        public DeleteBuildV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteBuildV2DeprecatedResponse.Builder resBuilder =
            ...
            DeleteBuildV2DeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteBuildV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.DeleteBuildV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteBuildV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBuildV2DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteBuildV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.DeleteBuildV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.DeleteBuildV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.DeleteBuildV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.DeleteBuildV2DeprecatedResponse res = resBuilder.build();
