...
public class GetLogsForProcess {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLogsForProcessRequest, GetLogsForProcessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLogsForProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLogsForProcessRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLogsForProcessRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "404", "408", "410", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public GetLogsForProcessResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLogsForProcessResponse.Builder resBuilder =
            ...
            GetLogsForProcessResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLogsForProcessRequest, dev.hathora.cloud_sdk.models.operations.async.GetLogsForProcessResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLogsForProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLogsForProcessRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLogsForProcessRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "404", "408", "410", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetLogsForProcessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetLogsForProcessResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetLogsForProcessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.hathora.cloud_sdk.models.operations.async.GetLogsForProcessResponse res = resBuilder.build();
