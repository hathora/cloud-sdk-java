...
public class GetBuildsV2Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBuildsV2DeprecatedRequest, GetBuildsV2DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetBuildsV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuildsV2DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBuildsV2DeprecatedRequest request) {
        ...
        @Override
        public GetBuildsV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClasses(Utils.unmarshal(response, new TypeReference<List<Build>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBuildsV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetBuildsV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetBuildsV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBuildsV2DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBuildsV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetBuildsV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetBuildsV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetBuildsV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetBuildsV2DeprecatedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<Build>>() {})
