...
public class GetDeploymentsV1DeprecatedOperation implements RequestOperation<GetDeploymentsV1DeprecatedRequest, GetDeploymentsV1DeprecatedResponse> {
    ...
    public GetDeploymentsV1DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetDeploymentsV1DeprecatedRequest request) throws Exception {
