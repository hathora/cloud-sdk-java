...
public class SetLobbyState {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetLobbyStateRequest, SetLobbyStateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(SetLobbyStateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetLobbyStateRequest.class, new TypeReference<SetLobbyStateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetLobbyStateRequest request) {
        ...
        @Override
        public SetLobbyStateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetLobbyStateResponse.Builder resBuilder =
            ...
            SetLobbyStateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetLobbyStateRequest, dev.hathora.cloud_sdk.models.operations.async.SetLobbyStateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(SetLobbyStateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetLobbyStateRequest.class, new TypeReference<SetLobbyStateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetLobbyStateRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.SetLobbyStateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.SetLobbyStateResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.SetLobbyStateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.SetLobbyStateResponse res = resBuilder.build();
