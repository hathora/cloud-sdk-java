...
public class GetConnectionInfoOperation implements RequestOperation<GetConnectionInfoRequest, GetConnectionInfoResponse> {
    ...
    public GetConnectionInfoOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetConnectionInfoRequest request) throws Exception {
