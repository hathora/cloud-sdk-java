...
public class GetLatestDeploymentV1DeprecatedOperation implements RequestOperation<GetLatestDeploymentV1DeprecatedRequest, GetLatestDeploymentV1DeprecatedResponse> {
    ...
    public GetLatestDeploymentV1DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLatestDeploymentV1DeprecatedRequest request) throws Exception {
