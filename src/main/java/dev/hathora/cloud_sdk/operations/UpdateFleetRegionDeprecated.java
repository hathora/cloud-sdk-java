...
public class UpdateFleetRegionDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateFleetRegionDeprecatedRequest, UpdateFleetRegionDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateFleetRegionDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateFleetRegionDeprecatedRequest.class, new TypeReference<UpdateFleetRegionDeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateFleetRegionDeprecatedRequest request) {
        ...
        @Override
        public UpdateFleetRegionDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateFleetRegionDeprecatedResponse.Builder resBuilder =
            ...
            UpdateFleetRegionDeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateFleetRegionDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.UpdateFleetRegionDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateFleetRegionDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateFleetRegionDeprecatedRequest.class, new TypeReference<UpdateFleetRegionDeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateFleetRegionDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.UpdateFleetRegionDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.UpdateFleetRegionDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.UpdateFleetRegionDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.UpdateFleetRegionDeprecatedResponse res = resBuilder.build();
