...
public class GetProcess {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProcessRequest, GetProcessResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProcessRequest request) {
        ...
        @Override
        public GetProcessResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetProcessResponse.Builder resBuilder =
                    GetProcessResponse
                            .builder()
            ...
            GetProcessResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProcessRequest, dev.hathora.cloud_sdk.models.operations.async.GetProcessResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetProcessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProcessRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProcessRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetProcessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetProcessResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetProcessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetProcessResponse res = resBuilder.build();
