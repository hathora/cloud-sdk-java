...
public class DeleteBuildDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteBuildDeprecatedRequest, DeleteBuildDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteBuildDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBuildDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteBuildDeprecatedRequest request) {
        ...
        @Override
        public DeleteBuildDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteBuildDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.DeleteBuildDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteBuildDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBuildDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteBuildDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.DeleteBuildDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.DeleteBuildDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.DeleteBuildDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.DeleteBuildDeprecatedResponse res = resBuilder.build();
