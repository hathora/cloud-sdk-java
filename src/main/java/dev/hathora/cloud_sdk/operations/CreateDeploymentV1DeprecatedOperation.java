...
public class CreateDeploymentV1DeprecatedOperation implements RequestOperation<CreateDeploymentV1DeprecatedRequest, CreateDeploymentV1DeprecatedResponse> {
    ...
    public CreateDeploymentV1DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateDeploymentV1DeprecatedRequest request) throws Exception {
