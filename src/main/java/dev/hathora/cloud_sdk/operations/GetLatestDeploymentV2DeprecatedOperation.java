...
public class GetLatestDeploymentV2DeprecatedOperation implements RequestOperation<GetLatestDeploymentV2DeprecatedRequest, GetLatestDeploymentV2DeprecatedResponse> {
    ...
    public GetLatestDeploymentV2DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLatestDeploymentV2DeprecatedRequest request) throws Exception {
