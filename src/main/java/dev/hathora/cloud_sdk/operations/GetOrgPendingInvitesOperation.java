...
public class GetOrgPendingInvitesOperation implements RequestOperation<GetOrgPendingInvitesRequest, GetOrgPendingInvitesResponse> {
    ...
    public GetOrgPendingInvitesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetOrgPendingInvitesRequest request) throws Exception {
