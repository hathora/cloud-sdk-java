...
public class GetUserPendingInvites {
    ...
    public static class Sync extends Base
        ...
        @Override
        public GetUserPendingInvitesResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.hathora.cloud_sdk.models.operations.async.GetUserPendingInvitesResponse> {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetUserPendingInvitesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetUserPendingInvitesResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetUserPendingInvitesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetUserPendingInvitesResponse res = resBuilder.build();
