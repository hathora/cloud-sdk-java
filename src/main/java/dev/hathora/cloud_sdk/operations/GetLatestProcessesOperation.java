...
public class GetLatestProcessesOperation implements RequestOperation<GetLatestProcessesRequest, GetLatestProcessesResponse> {
    ...
    public GetLatestProcessesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLatestProcessesRequest request) throws Exception {
