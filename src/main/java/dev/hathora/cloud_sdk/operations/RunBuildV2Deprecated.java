...
public class RunBuildV2Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<RunBuildV2DeprecatedRequest, RunBuildV2DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RunBuildV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RunBuildV2DeprecatedRequest.class, new TypeReference<RunBuildV2DeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RunBuildV2DeprecatedRequest request) {
        ...
        @Override
        public RunBuildV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RunBuildV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.RunBuildV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RunBuildV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RunBuildV2DeprecatedRequest.class, new TypeReference<RunBuildV2DeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RunBuildV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.RunBuildV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.RunBuildV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.RunBuildV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.hathora.cloud_sdk.models.operations.async.RunBuildV2DeprecatedResponse res = resBuilder.build();
