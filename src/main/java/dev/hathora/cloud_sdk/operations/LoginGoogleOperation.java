...
public class LoginGoogleOperation implements RequestOperation<LoginGoogleRequest, LoginGoogleResponse> {
    ...
    public LoginGoogleOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(LoginGoogleRequest request) throws Exception {
