...
public class DeleteAppOperation implements RequestOperation<DeleteAppRequest, DeleteAppResponse> {
    ...
    public DeleteAppOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(DeleteAppRequest request) throws Exception {
