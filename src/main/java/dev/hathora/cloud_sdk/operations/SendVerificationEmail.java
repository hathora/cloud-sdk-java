...
public class SendVerificationEmail {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VerificationEmailRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "429", "4XX", "500", "5XX")) {
        ...
        @Override
        public SendVerificationEmailResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    VerificationEmailSuccess out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withVerificationEmailSuccess(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(VerificationEmailRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "401", "429", "4XX", "500", "5XX")) {
