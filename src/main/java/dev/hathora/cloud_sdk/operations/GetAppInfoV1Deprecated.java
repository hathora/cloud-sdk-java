...
public class GetAppInfoV1Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAppInfoV1DeprecatedRequest, GetAppInfoV1DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAppInfoV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppInfoV1DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAppInfoV1DeprecatedRequest request) {
        ...
        @Override
        public GetAppInfoV1DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAppInfoV1DeprecatedResponse.Builder resBuilder =
            ...
            GetAppInfoV1DeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAppInfoV1DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetAppInfoV1DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAppInfoV1DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppInfoV1DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAppInfoV1DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetAppInfoV1DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetAppInfoV1DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetAppInfoV1DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetAppInfoV1DeprecatedResponse res = resBuilder.build();
