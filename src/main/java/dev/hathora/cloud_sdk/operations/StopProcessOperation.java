...
public class StopProcessOperation implements RequestOperation<StopProcessRequest, StopProcessResponse> {
    ...
    public StopProcessOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(StopProcessRequest request) throws Exception {
