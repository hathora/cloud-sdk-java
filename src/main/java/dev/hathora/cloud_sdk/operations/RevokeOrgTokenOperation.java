...
public class RevokeOrgTokenOperation implements RequestOperation<RevokeOrgTokenRequest, RevokeOrgTokenResponse> {
    ...
    public RevokeOrgTokenOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RevokeOrgTokenRequest request) throws Exception {
