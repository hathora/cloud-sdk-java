...
public class GetFleet {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFleetRequest, GetFleetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFleetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFleetRequest request) {
        ...
        @Override
        public GetFleetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFleetResponse.Builder resBuilder =
                    GetFleetResponse
                            .builder()
            ...
            GetFleetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFleetRequest, dev.hathora.cloud_sdk.models.operations.async.GetFleetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFleetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFleetRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetFleetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetFleetResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetFleetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetFleetResponse res = resBuilder.build();
