...
public class GetLobbyInfo {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLobbyInfoRequest, GetLobbyInfoResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLobbyInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLobbyInfoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLobbyInfoRequest request) {
        ...
        @Override
        public GetLobbyInfoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLobbyInfoResponse.Builder resBuilder =
            ...
            GetLobbyInfoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLobbyInfoRequest, dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLobbyInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLobbyInfoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLobbyInfoRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoResponse res = resBuilder.build();
