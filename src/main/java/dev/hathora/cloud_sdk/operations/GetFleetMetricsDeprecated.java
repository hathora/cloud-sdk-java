...
public class GetFleetMetricsDeprecated {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/fleets/v1/fleets/{fleetId}/metrics",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFleetMetricsDeprecatedRequest, GetFleetMetricsDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFleetMetricsDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetMetricsDeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFleetMetricsDeprecatedRequest request) {
        ...
        @Override
        public GetFleetMetricsDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFleetMetricsDeprecatedResponse.Builder resBuilder =
            ...
            GetFleetMetricsDeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFleetMetricsDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.GetFleetMetricsDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFleetMetricsDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetMetricsDeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFleetMetricsDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetFleetMetricsDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetFleetMetricsDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetFleetMetricsDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetFleetMetricsDeprecatedResponse res = resBuilder.build();
