...
public class GetNode {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetNodeRequest, GetNodeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetNodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNodeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetNodeRequest request) {
        ...
        @Override
        public GetNodeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetNodeResponse.Builder resBuilder =
                    GetNodeResponse
                            .builder()
            ...
            GetNodeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withNodeV1(Utils.unmarshal(response, new TypeReference<NodeV1>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetNodeRequest, dev.hathora.cloud_sdk.models.operations.async.GetNodeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetNodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNodeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetNodeRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetNodeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetNodeResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetNodeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetNodeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<NodeV1>() {})
                            .thenApply(res::withNodeV1);
                } else {
