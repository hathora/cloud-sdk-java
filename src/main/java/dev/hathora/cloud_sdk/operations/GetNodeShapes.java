...
import dev.hathora.cloud_sdk.models.shared.NodeShapeV2;
...
public class GetNodeShapes {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetNodeShapesRequest, GetNodeShapesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetNodeShapesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNodeShapesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetNodeShapesRequest request) {
        ...
        @Override
        public GetNodeShapesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetNodeShapesResponse.Builder resBuilder =
            ...
            GetNodeShapesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClasses(Utils.unmarshal(response, new TypeReference<List<NodeShapeV2>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetNodeShapesRequest, dev.hathora.cloud_sdk.models.operations.async.GetNodeShapesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetNodeShapesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNodeShapesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetNodeShapesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetNodeShapesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetNodeShapesResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetNodeShapesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetNodeShapesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<NodeShapeV2>>() {})
