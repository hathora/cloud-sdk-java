...
public class GetFleetMetricsOperation implements RequestOperation<GetFleetMetricsRequest, GetFleetMetricsResponse> {
    ...
    public GetFleetMetricsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetFleetMetricsRequest request) throws Exception {
