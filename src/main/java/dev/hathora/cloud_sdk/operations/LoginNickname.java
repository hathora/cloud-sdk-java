...
public class LoginNickname {
    ...
    public static class Sync extends Base
            implements RequestOperation<LoginNicknameRequest, LoginNicknameResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(LoginNicknameRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LoginNicknameRequest.class, new TypeReference<LoginNicknameRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LoginNicknameRequest request) {
        ...
        @Override
        public LoginNicknameResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LoginNicknameRequest, dev.hathora.cloud_sdk.models.operations.async.LoginNicknameResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(LoginNicknameRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LoginNicknameRequest.class, new TypeReference<LoginNicknameRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LoginNicknameRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.LoginNicknameResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.LoginNicknameResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.LoginNicknameResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.LoginNicknameResponse res = resBuilder.build();
