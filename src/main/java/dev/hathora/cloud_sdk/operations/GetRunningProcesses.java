...
public class GetRunningProcesses {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetRunningProcessesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRunningProcessesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRunningProcessesRequest request) {
        ...
        @Override
        public GetRunningProcessesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClasses(Utils.unmarshal(response, new TypeReference<List<ProcessWithRooms>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRunningProcessesRequest, dev.hathora.cloud_sdk.models.operations.async.GetRunningProcessesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRunningProcessesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRunningProcessesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRunningProcessesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetRunningProcessesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetRunningProcessesResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetRunningProcessesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetRunningProcessesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ProcessWithRooms>>() {})
