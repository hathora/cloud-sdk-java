...
public class GetLobbyInfoByRoomId {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLobbyInfoByRoomIdRequest, GetLobbyInfoByRoomIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLobbyInfoByRoomIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLobbyInfoByRoomIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLobbyInfoByRoomIdRequest request) {
        ...
        @Override
        public GetLobbyInfoByRoomIdResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLobbyInfoByRoomIdRequest, dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByRoomIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLobbyInfoByRoomIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLobbyInfoByRoomIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLobbyInfoByRoomIdRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByRoomIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByRoomIdResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByRoomIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetLobbyInfoByRoomIdResponse res = resBuilder.build();
