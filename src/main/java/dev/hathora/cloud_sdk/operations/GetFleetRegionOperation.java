...
public class GetFleetRegionOperation implements RequestOperation<GetFleetRegionRequest, GetFleetRegionResponse> {
    ...
    public GetFleetRegionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetFleetRegionRequest request) throws Exception {
