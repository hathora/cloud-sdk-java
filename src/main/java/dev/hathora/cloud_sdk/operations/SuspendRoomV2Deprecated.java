...
public class SuspendRoomV2Deprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<SuspendRoomV2DeprecatedRequest, SuspendRoomV2DeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(SuspendRoomV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SuspendRoomV2DeprecatedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SuspendRoomV2DeprecatedRequest request) {
        ...
        @Override
        public SuspendRoomV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SuspendRoomV2DeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.SuspendRoomV2DeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(SuspendRoomV2DeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SuspendRoomV2DeprecatedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SuspendRoomV2DeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.SuspendRoomV2DeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.SuspendRoomV2DeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.SuspendRoomV2DeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.SuspendRoomV2DeprecatedResponse res = resBuilder.build();
