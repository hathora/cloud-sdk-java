...
public class GetFleetRegionMetrics {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFleetRegionMetricsRequest, GetFleetRegionMetricsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFleetRegionMetricsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetRegionMetricsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFleetRegionMetricsRequest request) {
        ...
        @Override
        public GetFleetRegionMetricsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFleetRegionMetricsResponse.Builder resBuilder =
            ...
            GetFleetRegionMetricsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFleetRegionMetricsRequest, dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFleetRegionMetricsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFleetRegionMetricsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFleetRegionMetricsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetFleetRegionMetricsResponse res = resBuilder.build();
