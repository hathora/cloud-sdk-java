...
public class GetUserPendingInvitesOperation implements RequestlessOperation<GetUserPendingInvitesResponse> {
    ...
    public GetUserPendingInvitesOperation(SDKConfiguration sdkConfiguration) {
