...
public class PatchApp {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAppRequest, PatchAppResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAppRequest.class, new TypeReference<PatchAppRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAppRequest request) {
        ...
        @Override
        public PatchAppResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAppRequest, dev.hathora.cloud_sdk.models.operations.async.PatchAppResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAppRequest.class, new TypeReference<PatchAppRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAppRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.PatchAppResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.PatchAppResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.PatchAppResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.PatchAppResponse res = resBuilder.build();
