...
public class GetActiveRoomsForProcessOperation implements RequestOperation<GetActiveRoomsForProcessRequest, GetActiveRoomsForProcessResponse> {
    ...
    public GetActiveRoomsForProcessOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetActiveRoomsForProcessRequest request) throws Exception {
