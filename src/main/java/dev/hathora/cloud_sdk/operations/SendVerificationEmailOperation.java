...
public class SendVerificationEmailOperation implements RequestOperation<VerificationEmailRequest, SendVerificationEmailResponse> {
    ...
    public SendVerificationEmailOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(VerificationEmailRequest request) throws Exception {
