...
public class UpdateUserInvite {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUserInviteRequest, UpdateUserInviteResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateUserInviteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUserInviteRequest.class, new TypeReference<UpdateUserInviteRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUserInviteRequest request) {
        ...
        @Override
        public UpdateUserInviteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUserInviteResponse.Builder resBuilder =
            ...
            UpdateUserInviteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBoolean(Utils.unmarshal(response, new TypeReference<Boolean>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUserInviteRequest, dev.hathora.cloud_sdk.models.operations.async.UpdateUserInviteResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUserInviteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUserInviteRequest.class, new TypeReference<UpdateUserInviteRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUserInviteRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.UpdateUserInviteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.UpdateUserInviteResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.UpdateUserInviteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.UpdateUserInviteResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Boolean>() {})
                            .thenApply(res::withBoolean);
                } else {
