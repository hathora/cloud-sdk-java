...
public class InviteUser {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(InviteUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InviteUserRequest.class, new TypeReference<InviteUserRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InviteUserRequest request) {
        ...
        @Override
        public InviteUserResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPendingOrgInvite(Utils.unmarshal(response, new TypeReference<PendingOrgInvite>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<InviteUserRequest, dev.hathora.cloud_sdk.models.operations.async.InviteUserResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(InviteUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InviteUserRequest.class, new TypeReference<InviteUserRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(InviteUserRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.InviteUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.InviteUserResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.InviteUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.InviteUserResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PendingOrgInvite>() {})
                            .thenApply(res::withPendingOrgInvite);
                } else {
