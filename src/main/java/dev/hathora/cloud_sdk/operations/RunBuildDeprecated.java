...
public class RunBuildDeprecated {
    ...
    public static class Sync extends Base
            implements RequestOperation<RunBuildDeprecatedRequest, RunBuildDeprecatedResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RunBuildDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RunBuildDeprecatedRequest.class, new TypeReference<RunBuildDeprecatedRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RunBuildDeprecatedRequest request) {
        ...
        @Override
        public RunBuildDeprecatedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RunBuildDeprecatedResponse.Builder resBuilder =
            ...
            RunBuildDeprecatedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RunBuildDeprecatedRequest, dev.hathora.cloud_sdk.models.operations.async.RunBuildDeprecatedResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RunBuildDeprecatedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RunBuildDeprecatedRequest.class, new TypeReference<RunBuildDeprecatedRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RunBuildDeprecatedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.RunBuildDeprecatedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.RunBuildDeprecatedResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.RunBuildDeprecatedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.RunBuildDeprecatedResponse res = resBuilder.build();
