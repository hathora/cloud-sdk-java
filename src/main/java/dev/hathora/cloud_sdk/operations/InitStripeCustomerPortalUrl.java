...
public class InitStripeCustomerPortalUrl {
    ...
    public static class Sync extends Base
            implements RequestOperation<InitStripeCustomerPortalUrlRequest, InitStripeCustomerPortalUrlResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(InitStripeCustomerPortalUrlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InitStripeCustomerPortalUrlRequest.class, new TypeReference<InitStripeCustomerPortalUrlRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(InitStripeCustomerPortalUrlRequest request) {
        ...
        @Override
        public InitStripeCustomerPortalUrlResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withString(Utils.unmarshal(response, new TypeReference<String>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<InitStripeCustomerPortalUrlRequest, dev.hathora.cloud_sdk.models.operations.async.InitStripeCustomerPortalUrlResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(InitStripeCustomerPortalUrlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, InitStripeCustomerPortalUrlRequest.class, new TypeReference<InitStripeCustomerPortalUrlRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(InitStripeCustomerPortalUrlRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.InitStripeCustomerPortalUrlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.InitStripeCustomerPortalUrlResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.InitStripeCustomerPortalUrlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.InitStripeCustomerPortalUrlResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<String>() {})
                            .thenApply(res::withString);
                } else {
