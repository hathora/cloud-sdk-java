...
public class GetPingServiceEndpoints {
    ...
    public static class Sync extends Base
        ...
        @Override
        public GetPingServiceEndpointsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsResponse> {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetPingServiceEndpointsResponse res = resBuilder.build();
