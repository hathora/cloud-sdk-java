...
public class GetApp {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAppRequest, GetAppResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAppRequest request) {
        ...
        @Override
        public GetAppResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAppRequest, dev.hathora.cloud_sdk.models.operations.async.GetAppResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAppRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAppRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetAppResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetAppResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetAppResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetAppResponse res = resBuilder.build();
