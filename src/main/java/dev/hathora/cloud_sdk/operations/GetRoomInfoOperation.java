...
public class GetRoomInfoOperation implements RequestOperation<GetRoomInfoRequest, GetRoomInfoResponse> {
    ...
    public GetRoomInfoOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetRoomInfoRequest request) throws Exception {
