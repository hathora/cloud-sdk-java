...
public class GetLobbyInfoOperation implements RequestOperation<GetLobbyInfoRequest, GetLobbyInfoResponse> {
    ...
    public GetLobbyInfoOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLobbyInfoRequest request) throws Exception {
