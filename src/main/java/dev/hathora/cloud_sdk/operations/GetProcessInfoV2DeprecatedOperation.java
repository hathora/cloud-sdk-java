...
public class GetProcessInfoV2DeprecatedOperation implements RequestOperation<GetProcessInfoV2DeprecatedRequest, GetProcessInfoV2DeprecatedResponse> {
    ...
    public GetProcessInfoV2DeprecatedOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetProcessInfoV2DeprecatedRequest request) throws Exception {
