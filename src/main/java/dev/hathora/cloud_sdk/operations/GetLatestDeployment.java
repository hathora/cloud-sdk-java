...
public class GetLatestDeployment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLatestDeploymentRequest, GetLatestDeploymentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLatestDeploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLatestDeploymentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLatestDeploymentRequest request) {
        ...
        @Override
        public GetLatestDeploymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLatestDeploymentResponse.Builder resBuilder =
            ...
            GetLatestDeploymentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeploymentV3(Utils.unmarshal(response, new TypeReference<DeploymentV3>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLatestDeploymentRequest, dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLatestDeploymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLatestDeploymentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLatestDeploymentRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.GetLatestDeploymentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeploymentV3>() {})
                            .thenApply(res::withDeploymentV3);
                } else {
