...
public class GetDeploymentsV2Deprecated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeploymentsV2DeprecatedRequest request) throws Exception {
        ...
        @Override
        public GetDeploymentsV2DeprecatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<DeploymentV2> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withClasses(out);
