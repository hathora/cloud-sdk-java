...
public class GetAppsV1Deprecated {
    ...
    public static class Sync extends Base
        ...
        @Override
        public GetAppsV1DeprecatedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ApplicationWithLatestDeploymentAndBuildDeprecated> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withClasses(out);
