...
public class DestroyRoom {
    ...
    public static class Sync extends Base
            implements RequestOperation<DestroyRoomRequest, DestroyRoomResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DestroyRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DestroyRoomRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DestroyRoomRequest request) {
        ...
        @Override
        public DestroyRoomResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DestroyRoomResponse.Builder resBuilder =
                    DestroyRoomResponse
                            .builder()
            ...
            DestroyRoomResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DestroyRoomRequest, dev.hathora.cloud_sdk.models.operations.async.DestroyRoomResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DestroyRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DestroyRoomRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DestroyRoomRequest request) {
        ...
        @Override
        public CompletableFuture<dev.hathora.cloud_sdk.models.operations.async.DestroyRoomResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.hathora.cloud_sdk.models.operations.async.DestroyRoomResponse.Builder resBuilder =
                    dev.hathora.cloud_sdk.models.operations.async.DestroyRoomResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.hathora.cloud_sdk.models.operations.async.DestroyRoomResponse res = resBuilder.build();
