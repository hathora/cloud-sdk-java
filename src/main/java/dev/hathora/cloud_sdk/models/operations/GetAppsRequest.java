...
public class GetAppsRequest {
    ...
    public GetAppsRequest withOrgId(String orgId) {
        Utils.checkNotNull(orgId, "orgId");
        this.orgId = Optional.ofNullable(orgId);
        return this;
    }

    public GetAppsRequest withOrgId(Optional<String> orgId) {
        Utils.checkNotNull(orgId, "orgId");
        this.orgId = orgId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAppsRequest other = (GetAppsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAppsRequest.class,
                "orgId", orgId);
    }
