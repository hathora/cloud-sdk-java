...
public class GetFleetRegionMetricsDeprecatedRequest {
    ...
    @JsonCreator
    public GetFleetRegionMetricsDeprecatedRequest(
            Optional<Double> end,
            String fleetId,
    ...
    public GetFleetRegionMetricsDeprecatedRequest withEnd(double end) {
        Utils.checkNotNull(end, "end");
    ...
    public GetFleetRegionMetricsDeprecatedRequest withEnd(Optional<Double> end) {
        Utils.checkNotNull(end, "end");
        this.end = end;
        return this;
    }

    public GetFleetRegionMetricsDeprecatedRequest withFleetId(String fleetId) {
        Utils.checkNotNull(fleetId, "fleetId");
        this.fleetId = fleetId;
        return this;
    }
     ...
     * Available metrics to query over time.
     */
    public GetFleetRegionMetricsDeprecatedRequest withMetrics(List<FleetMetricName> metrics) {
        Utils.checkNotNull(metrics, "metrics");
     ...
     * Available metrics to query over time.
     */
    public GetFleetRegionMetricsDeprecatedRequest withMetrics(Optional<? extends List<FleetMetricName>> metrics) {
        Utils.checkNotNull(metrics, "metrics");
        this.metrics = metrics;
        return this;
    }

    public GetFleetRegionMetricsDeprecatedRequest withOrgId(String orgId) {
        Utils.checkNotNull(orgId, "orgId");
    ...
    public GetFleetRegionMetricsDeprecatedRequest withOrgId(Optional<String> orgId) {
        Utils.checkNotNull(orgId, "orgId");
        this.orgId = orgId;
        return this;
    }

    public GetFleetRegionMetricsDeprecatedRequest withRegion(Region region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * Unix timestamp. Default is -1 hour from `end`.
     */
    public GetFleetRegionMetricsDeprecatedRequest withStart(double start) {
        Utils.checkNotNull(start, "start");
     ...
     * Unix timestamp. Default is -1 hour from `end`.
     */
    public GetFleetRegionMetricsDeprecatedRequest withStart(Optional<Double> start) {
        Utils.checkNotNull(start, "start");
        this.start = start;
        return this;
    }

    public GetFleetRegionMetricsDeprecatedRequest withStep(int step) {
        Utils.checkNotNull(step, "step");
    ...
    public GetFleetRegionMetricsDeprecatedRequest withStep(Optional<Integer> step) {
        Utils.checkNotNull(step, "step");
        this.step = step;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFleetRegionMetricsDeprecatedRequest other = (GetFleetRegionMetricsDeprecatedRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFleetRegionMetricsDeprecatedRequest.class,
                "end", end,
                "fleetId", fleetId,
                "metrics", metrics,
                "orgId", orgId,
    ...
    public final static class Builder {
        ...
        public GetFleetRegionMetricsDeprecatedRequest build() {
            if (step == null) {
                step = _SINGLETON_VALUE_Step.value();
            }

            return new GetFleetRegionMetricsDeprecatedRequest(
                end, fleetId, metrics,
                orgId, region, start,
                step);
        }
