...
import dev.hathora.cloud_sdk.models.shared.ProcessMetricName;
...
public class GetProcessMetricsRequest {
    ...
    private Optional<? extends List<ProcessMetricName>> metrics;
    ...
    @JsonCreator
    public GetProcessMetricsRequest(
            Optional<String> appId,
            Optional<Double> end,
            Optional<? extends List<ProcessMetricName>> metrics,
            String processId,
    ...
    @JsonIgnore
    public Optional<List<ProcessMetricName>> metrics() {
        return (Optional<List<ProcessMetricName>>) metrics;
    }
    ...
    public GetProcessMetricsRequest withAppId(String appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = Optional.ofNullable(appId);
        return this;
    }

    public GetProcessMetricsRequest withAppId(Optional<String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
     ...
     * Unix timestamp. Default is current time.
     */
    public GetProcessMetricsRequest withEnd(double end) {
        Utils.checkNotNull(end, "end");
     ...
     * Unix timestamp. Default is current time.
     */
    public GetProcessMetricsRequest withEnd(Optional<Double> end) {
        Utils.checkNotNull(end, "end");
        this.end = end;
        return this;
    }
     ...
     * Available metrics to query over time.
     */
    public GetProcessMetricsRequest withMetrics(List<ProcessMetricName> metrics) {
        Utils.checkNotNull(metrics, "metrics");
     ...
     * Available metrics to query over time.
     */
    public GetProcessMetricsRequest withMetrics(Optional<? extends List<ProcessMetricName>> metrics) {
        Utils.checkNotNull(metrics, "metrics");
        this.metrics = metrics;
        return this;
    }
     ...
     * Unix timestamp. Default is -1 hour from `end`.
     */
    public GetProcessMetricsRequest withStart(double start) {
        Utils.checkNotNull(start, "start");
     ...
     * Unix timestamp. Default is -1 hour from `end`.
     */
    public GetProcessMetricsRequest withStart(Optional<Double> start) {
        Utils.checkNotNull(start, "start");
        this.start = start;
        return this;
    }

    public GetProcessMetricsRequest withStep(int step) {
        Utils.checkNotNull(step, "step");
        this.step = Optional.ofNullable(step);
        return this;
    }

    public GetProcessMetricsRequest withStep(Optional<Integer> step) {
        Utils.checkNotNull(step, "step");
        this.step = step;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(GetProcessMetricsRequest.class,
                "appId", appId,
                "end", end,
                "metrics", metrics,
                "processId", processId,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<ProcessMetricName>> metrics = Optional.empty();
         ...
         * Available metrics to query over time.
         */
        public Builder metrics(List<ProcessMetricName> metrics) {
            Utils.checkNotNull(metrics, "metrics");
            this.metrics = Optional.ofNullable(metrics);
            return this;
        }
         ...
         * Available metrics to query over time.
         */
        public Builder metrics(Optional<? extends List<ProcessMetricName>> metrics) {
            Utils.checkNotNull(metrics, "metrics");
            this.metrics = metrics;
            return this;
        }
        ...
        public GetProcessMetricsRequest build() {
            if (step == null) {
                step = _SINGLETON_VALUE_Step.value();
            }            return new GetProcessMetricsRequest(
                appId,
                end,
                metrics,
                processId,
