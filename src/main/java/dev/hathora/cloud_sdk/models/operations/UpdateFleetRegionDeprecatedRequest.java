...
public class UpdateFleetRegionDeprecatedRequest {
    ...
    @JsonCreator
    public UpdateFleetRegionDeprecatedRequest(
    ...
    public UpdateFleetRegionDeprecatedRequest withFleetRegionConfig(FleetRegionConfig fleetRegionConfig) {
        Utils.checkNotNull(fleetRegionConfig, "fleetRegionConfig");
        this.fleetRegionConfig = fleetRegionConfig;
        return this;
    }

    public UpdateFleetRegionDeprecatedRequest withFleetId(String fleetId) {
        Utils.checkNotNull(fleetId, "fleetId");
        this.fleetId = fleetId;
        return this;
    }

    public UpdateFleetRegionDeprecatedRequest withOrgId(String orgId) {
        Utils.checkNotNull(orgId, "orgId");
    ...
    public UpdateFleetRegionDeprecatedRequest withOrgId(Optional<String> orgId) {
        Utils.checkNotNull(orgId, "orgId");
        this.orgId = orgId;
        return this;
    }

    public UpdateFleetRegionDeprecatedRequest withRegion(Region region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateFleetRegionDeprecatedRequest other = (UpdateFleetRegionDeprecatedRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateFleetRegionDeprecatedRequest.class,
                "fleetRegionConfig", fleetRegionConfig,
                "fleetId", fleetId,
                "orgId", orgId,
                "region", region);
    ...
    public final static class Builder {
        ...
        public UpdateFleetRegionDeprecatedRequest build() {

            return new UpdateFleetRegionDeprecatedRequest(
                fleetRegionConfig, fleetId, orgId,
                region);
        }
