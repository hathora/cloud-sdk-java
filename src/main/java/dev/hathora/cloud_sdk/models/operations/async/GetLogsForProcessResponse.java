...
public class GetLogsForProcessResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetLogsForProcessResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Ok
     */
    public GetLogsForProcessResponse withResponseStream(Blob responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
     ...
     * Ok
     */
    public GetLogsForProcessResponse withResponseStream(Optional<? extends Blob> responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
        this.responseStream = responseStream;
        return this;
    }
