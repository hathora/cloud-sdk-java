...
public class GetFleetRegionMetricsRequest {
    ...
    @JsonCreator
    public GetFleetRegionMetricsRequest(
            Optional<Double> end,
            String fleetId,
    ...
    public GetFleetRegionMetricsRequest withEnd(double end) {
        Utils.checkNotNull(end, "end");
    ...
    public GetFleetRegionMetricsRequest withEnd(Optional<Double> end) {
        Utils.checkNotNull(end, "end");
        this.end = end;
        return this;
    }

    public GetFleetRegionMetricsRequest withFleetId(String fleetId) {
        Utils.checkNotNull(fleetId, "fleetId");
        this.fleetId = fleetId;
        return this;
    }
     ...
     * Available metrics to query over time.
     */
    public GetFleetRegionMetricsRequest withMetrics(List<FleetMetricName> metrics) {
        Utils.checkNotNull(metrics, "metrics");
     ...
     * Available metrics to query over time.
     */
    public GetFleetRegionMetricsRequest withMetrics(Optional<? extends List<FleetMetricName>> metrics) {
        Utils.checkNotNull(metrics, "metrics");
        this.metrics = metrics;
        return this;
    }

    public GetFleetRegionMetricsRequest withOrgId(String orgId) {
        Utils.checkNotNull(orgId, "orgId");
    ...
    public GetFleetRegionMetricsRequest withOrgId(Optional<String> orgId) {
        Utils.checkNotNull(orgId, "orgId");
        this.orgId = orgId;
        return this;
    }

    public GetFleetRegionMetricsRequest withRegion(Region region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
     ...
     * Unix timestamp. Default is -1 hour from `end`.
     */
    public GetFleetRegionMetricsRequest withStart(double start) {
        Utils.checkNotNull(start, "start");
     ...
     * Unix timestamp. Default is -1 hour from `end`.
     */
    public GetFleetRegionMetricsRequest withStart(Optional<Double> start) {
        Utils.checkNotNull(start, "start");
        this.start = start;
        return this;
    }

    public GetFleetRegionMetricsRequest withStep(int step) {
        Utils.checkNotNull(step, "step");
    ...
    public GetFleetRegionMetricsRequest withStep(Optional<Integer> step) {
        Utils.checkNotNull(step, "step");
        this.step = step;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFleetRegionMetricsRequest other = (GetFleetRegionMetricsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFleetRegionMetricsRequest.class,
                "end", end,
                "fleetId", fleetId,
                "metrics", metrics,
                "orgId", orgId,
    ...
    public final static class Builder {
        ...
        public GetFleetRegionMetricsRequest build() {
            if (step == null) {
                step = _SINGLETON_VALUE_Step.value();
            }

            return new GetFleetRegionMetricsRequest(
                end, fleetId, metrics,
                orgId, region, start,
                step);
        }
