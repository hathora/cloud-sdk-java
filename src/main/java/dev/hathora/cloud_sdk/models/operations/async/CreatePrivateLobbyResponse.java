...
public class CreatePrivateLobbyResponse implements AsyncResponse {
    /**
    ...
    public CreatePrivateLobbyResponse withLobby(Lobby lobby) {
        Utils.checkNotNull(lobby, "lobby");
    ...
    public CreatePrivateLobbyResponse withLobby(Optional<? extends Lobby> lobby) {
        Utils.checkNotNull(lobby, "lobby");
        this.lobby = lobby;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePrivateLobbyResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
