...
public class RunBuildResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RunBuildResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Ok
     */
    public RunBuildResponse withResponseStream(Blob responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
     ...
     * Ok
     */
    public RunBuildResponse withResponseStream(Optional<? extends Blob> responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
        this.responseStream = responseStream;
        return this;
    }
