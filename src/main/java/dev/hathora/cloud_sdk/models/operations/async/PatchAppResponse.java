...
public class PatchAppResponse implements AsyncResponse {
    /**
     * Ok
     */
     ...
     * Ok
     */
    public PatchAppResponse withApplication(Application application) {
        Utils.checkNotNull(application, "application");
     ...
     * Ok
     */
    public PatchAppResponse withApplication(Optional<? extends Application> application) {
        Utils.checkNotNull(application, "application");
        this.application = application;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public PatchAppResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PatchAppResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchAppResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchAppResponse other = (PatchAppResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchAppResponse.class,
    ...
    public final static class Builder {
        ...
        public PatchAppResponse build() {

            return new PatchAppResponse(
                application, contentType, statusCode,
                rawResponse);
        }
