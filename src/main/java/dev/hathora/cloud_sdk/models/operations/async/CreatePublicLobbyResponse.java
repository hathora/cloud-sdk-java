...
public class CreatePublicLobbyResponse implements AsyncResponse {
    /**
    ...
    public CreatePublicLobbyResponse withLobby(Lobby lobby) {
        Utils.checkNotNull(lobby, "lobby");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePublicLobbyResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
