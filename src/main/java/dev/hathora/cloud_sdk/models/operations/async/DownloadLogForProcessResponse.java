...
public class DownloadLogForProcessResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DownloadLogForProcessResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Ok
     */
    public DownloadLogForProcessResponse withResponseStream(Blob responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
     ...
     * Ok
     */
    public DownloadLogForProcessResponse withResponseStream(Optional<? extends Blob> responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
        this.responseStream = responseStream;
        return this;
    }
