...
public class DeleteBuildV2DeprecatedRequest {
    ...
    @JsonCreator
    public DeleteBuildV2DeprecatedRequest(
    ...
    public DeleteBuildV2DeprecatedRequest withBuildId(int buildId) {
        Utils.checkNotNull(buildId, "buildId");
        this.buildId = buildId;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(DeleteBuildV2DeprecatedRequest.class,
                "appId", appId,
                "buildId", buildId);
    }
