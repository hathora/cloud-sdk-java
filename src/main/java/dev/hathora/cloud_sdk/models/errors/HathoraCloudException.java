...
public abstract class HathoraCloudException extends RuntimeException {

    private int code;
    private byte[] body;
    private HttpResponse<?> rawResponse;

    public HathoraCloudException(String message, int code, @Nullable byte[] body, HttpResponse<?> rawResponse, @Nullable Throwable cause) {
        super(message, cause);
    ...
    public HathoraCloudException withCode(int code) {
        this.code = code;
        return this;
    }
    
    public HathoraCloudException withBody(@Nullable byte[] body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }
    
    public HathoraCloudException withRawResponse(HttpResponse<?> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
