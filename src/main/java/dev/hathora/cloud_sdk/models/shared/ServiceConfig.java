...
public class ServiceConfig {
    ...
    public ServiceConfig withLoadBalancer(LoadBalancerConfig loadBalancer) {
        Utils.checkNotNull(loadBalancer, "loadBalancer");
    ...
    public ServiceConfig withLoadBalancer(Optional<? extends LoadBalancerConfig> loadBalancer) {
        Utils.checkNotNull(loadBalancer, "loadBalancer");
        this.loadBalancer = loadBalancer;
        return this;
    }
     ...
     * EXPERIMENTAL - This feature is in closed beta.
     */
    public ServiceConfig withProcessAutoscalerConfig(ProcessAutoscalerConfig processAutoscalerConfig) {
        Utils.checkNotNull(processAutoscalerConfig, "processAutoscalerConfig");
     ...
     * EXPERIMENTAL - This feature is in closed beta.
     */
    public ServiceConfig withProcessAutoscalerConfig(Optional<? extends ProcessAutoscalerConfig> processAutoscalerConfig) {
        Utils.checkNotNull(processAutoscalerConfig, "processAutoscalerConfig");
        this.processAutoscalerConfig = processAutoscalerConfig;
        return this;
    }
     ...
     * The headroom configuration for each region.
     */
    public ServiceConfig withStaticProcessAllocation(List<StaticProcessAllocationConfig> staticProcessAllocation) {
        Utils.checkNotNull(staticProcessAllocation, "staticProcessAllocation");
        this.staticProcessAllocation = staticProcessAllocation;
        return this;
    }
