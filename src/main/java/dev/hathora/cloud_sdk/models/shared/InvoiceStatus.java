 ...
 *
 */
@JsonDeserialize(using = InvoiceStatus._Deserializer.class)
@JsonSerialize(using = InvoiceStatus._Serializer.class)
public class InvoiceStatus {

    public static final InvoiceStatus PENDING = new InvoiceStatus("pending");
    ...
    private static final Map<String, InvoiceStatusEnum> createEnumsMap() {
        ...
        map.put("pending", InvoiceStatusEnum.PENDING);
    ...
    public static final class _Serializer extends StdSerializer<InvoiceStatus> {
        ...
        @Override
        public void serialize(InvoiceStatus value, JsonGenerator g, SerializerProvider provider)
    ...
    @SuppressWarnings("serial")
    public static final class _Deserializer extends StdDeserializer<InvoiceStatus> {
