...
public class AsyncProcessesV2 {
     ...
     * 
     * @param region 
     * @return {@code CompletableFuture<CreateProcessV2DeprecatedResponse>} - The async response
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    @Deprecated
     ...
     * the array by optionally passing in a `status` or `region`.
     * 
     * @return {@code CompletableFuture<GetLatestProcessesV2DeprecatedResponse>} - The async response
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    @Deprecated
     ...
     * 
     * @param processId 
     * @return {@code CompletableFuture<GetProcessInfoV2DeprecatedResponse>} - The async response
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    @Deprecated
     ...
     * optionally passing in a `status` or `region`.
     * 
     * @return {@code CompletableFuture<GetProcessesCountExperimentalV2DeprecatedResponse>} - The async response
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    @Deprecated
     ...
     * 
     * @param processId 
     * @return {@code CompletableFuture<StopProcessV2DeprecatedResponse>} - The async response
     * @deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
     */
    @Deprecated
