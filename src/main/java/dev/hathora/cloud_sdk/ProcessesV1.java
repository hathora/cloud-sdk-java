...
import dev.hathora.cloud_sdk.operations.GetProcessInfoDeprecatedOperation;
import dev.hathora.cloud_sdk.operations.GetRunningProcessesOperation;
import dev.hathora.cloud_sdk.operations.GetStoppedProcessesOperation;
...
public class ProcessesV1 {
    ...
    public GetProcessInfoDeprecatedResponse getProcessInfoDeprecated(
        ...
        RequestOperation<GetProcessInfoDeprecatedRequest, GetProcessInfoDeprecatedResponse> operation
              = new GetProcessInfoDeprecatedOperation( sdkConfiguration);
    ...
    public GetRunningProcessesResponse getRunningProcesses(
        ...
        RequestOperation<GetRunningProcessesRequest, GetRunningProcessesResponse> operation
              = new GetRunningProcessesOperation( sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
    ...
    public GetStoppedProcessesResponse getStoppedProcesses(
        ...
        RequestOperation<GetStoppedProcessesRequest, GetStoppedProcessesResponse> operation
              = new GetStoppedProcessesOperation( sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
