...
public class GetRoomInfoResponse implements dev.hathora.cloud_api.utils.Response {
    ...
    public GetRoomInfoResponse withApiError(dev.hathora.cloud_api.models.shared.ApiError apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = Optional.ofNullable(apiError);
        return this;
    }

    public GetRoomInfoResponse withApiError(Optional<? extends dev.hathora.cloud_api.models.shared.ApiError> apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = apiError;
        return this;
    }
     ...
     * Ok
     */
    public GetRoomInfoResponse withRoom(Optional<? extends dev.hathora.cloud_api.models.shared.Room> room) {
        Utils.checkNotNull(room, "room");
        this.room = room;
        return this;
    }
