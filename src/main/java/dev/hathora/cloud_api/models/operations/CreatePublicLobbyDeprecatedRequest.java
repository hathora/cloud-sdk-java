...
public class CreatePublicLobbyDeprecatedRequest {
    ...
    public CreatePublicLobbyDeprecatedRequest withRegion(dev.hathora.cloud_api.models.shared.Region region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.ofNullable(region);
        return this;
    }

    public CreatePublicLobbyDeprecatedRequest withRegion(Optional<? extends dev.hathora.cloud_api.models.shared.Region> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
