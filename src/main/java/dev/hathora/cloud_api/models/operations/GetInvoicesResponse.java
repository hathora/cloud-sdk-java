...
public class GetInvoicesResponse implements dev.hathora.cloud_api.utils.Response {
    ...
    @JsonIgnore
    public Optional<java.util.List<dev.hathora.cloud_api.models.shared.Invoice>> classes() {
        return (Optional<java.util.List<dev.hathora.cloud_api.models.shared.Invoice>>) classes;
    }
