...
public class CreateLocalLobbyResponse implements dev.hathora.cloud_api.utils.Response {
    ...
    public CreateLocalLobbyResponse withApiError(dev.hathora.cloud_api.models.shared.ApiError apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = Optional.ofNullable(apiError);
        return this;
    }

    public CreateLocalLobbyResponse withApiError(Optional<? extends dev.hathora.cloud_api.models.shared.ApiError> apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = apiError;
        return this;
    }
    ...
    public CreateLocalLobbyResponse withLobby(Optional<? extends dev.hathora.cloud_api.models.shared.Lobby> lobby) {
        Utils.checkNotNull(lobby, "lobby");
        this.lobby = lobby;
        return this;
    }
