...
public class DestroyRoomDeprecatedResponse implements dev.hathora.cloud_api.utils.Response {
    ...
    public DestroyRoomDeprecatedResponse(
    ...
    public DestroyRoomDeprecatedResponse withApiError(dev.hathora.cloud_api.models.shared.ApiError apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = Optional.ofNullable(apiError);
        return this;
    }

    public DestroyRoomDeprecatedResponse withApiError(Optional<? extends dev.hathora.cloud_api.models.shared.ApiError> apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = apiError;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public DestroyRoomDeprecatedResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DestroyRoomDeprecatedResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestroyRoomDeprecatedResponse other = (DestroyRoomDeprecatedResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestroyRoomDeprecatedResponse.class,
                "apiError", apiError,
