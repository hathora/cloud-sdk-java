...
public class DestroyRoomRequest {
    ...
    public DestroyRoomRequest withAppId(Optional<? extends String> appId) {
        Utils.checkNotNull(appId, "appId");
        this.appId = appId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestroyRoomRequest other = (DestroyRoomRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestroyRoomRequest.class,
                "appId", appId,
                "roomId", roomId);
    }
    ...
    public final static class Builder {
        ...
        public DestroyRoomRequest build() {
            return new DestroyRoomRequest(
                appId,
                roomId);
        }
    }
