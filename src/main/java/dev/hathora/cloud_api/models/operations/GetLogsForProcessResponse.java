...
public class GetLogsForProcessResponse implements dev.hathora.cloud_api.utils.Response {
    ...
    public GetLogsForProcessResponse(
    ...
    public GetLogsForProcessResponse withApiError(dev.hathora.cloud_api.models.shared.ApiError apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = Optional.ofNullable(apiError);
        return this;
    }

    public GetLogsForProcessResponse withApiError(Optional<? extends dev.hathora.cloud_api.models.shared.ApiError> apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = apiError;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetLogsForProcessResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetLogsForProcessResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Ok
     */
    public GetLogsForProcessResponse withRes(String res) {
        Utils.checkNotNull(res, "res");
     ...
     * Ok
     */
    public GetLogsForProcessResponse withRes(Optional<? extends String> res) {
        Utils.checkNotNull(res, "res");
        this.res = res;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetLogsForProcessResponse other = (GetLogsForProcessResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetLogsForProcessResponse.class,
                "apiError", apiError,
    ...
    public final static class Builder {
        ...
        public GetLogsForProcessResponse build() {
            return new GetLogsForProcessResponse(
                apiError,
                contentType,
                statusCode,
                rawResponse,
