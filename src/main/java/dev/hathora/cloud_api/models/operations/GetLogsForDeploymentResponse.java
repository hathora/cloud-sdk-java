...
public class GetLogsForDeploymentResponse implements dev.hathora.cloud_api.utils.Response {
    ...
    public GetLogsForDeploymentResponse(
    ...
    public GetLogsForDeploymentResponse withApiError(dev.hathora.cloud_api.models.shared.ApiError apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = Optional.ofNullable(apiError);
        return this;
    }

    public GetLogsForDeploymentResponse withApiError(Optional<? extends dev.hathora.cloud_api.models.shared.ApiError> apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = apiError;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetLogsForDeploymentResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetLogsForDeploymentResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Ok
     */
    public GetLogsForDeploymentResponse withRes(String res) {
        Utils.checkNotNull(res, "res");
     ...
     * Ok
     */
    public GetLogsForDeploymentResponse withRes(Optional<? extends String> res) {
        Utils.checkNotNull(res, "res");
        this.res = res;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetLogsForDeploymentResponse other = (GetLogsForDeploymentResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetLogsForDeploymentResponse.class,
                "apiError", apiError,
    ...
    public final static class Builder {
        ...
        public GetLogsForDeploymentResponse build() {
            return new GetLogsForDeploymentResponse(
                apiError,
                contentType,
                statusCode,
                rawResponse,
