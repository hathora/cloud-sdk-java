...
public class DestroyRoomResponse implements dev.hathora.cloud_api.utils.Response {
    ...
    public DestroyRoomResponse withApiError(dev.hathora.cloud_api.models.shared.ApiError apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = Optional.ofNullable(apiError);
        return this;
    }

    public DestroyRoomResponse withApiError(Optional<? extends dev.hathora.cloud_api.models.shared.ApiError> apiError) {
        Utils.checkNotNull(apiError, "apiError");
        this.apiError = apiError;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public DestroyRoomResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DestroyRoomResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DestroyRoomResponse other = (DestroyRoomResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DestroyRoomResponse.class,
                "apiError", apiError,
    ...
    public final static class Builder {
        ...
        public DestroyRoomResponse build() {
            return new DestroyRoomResponse(
                apiError,
                contentType,
                statusCode,
                rawResponse);
