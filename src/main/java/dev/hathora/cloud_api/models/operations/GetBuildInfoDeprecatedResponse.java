...
public class GetBuildInfoDeprecatedResponse implements dev.hathora.cloud_api.utils.Response {
     ...
     * Ok
     */
    public GetBuildInfoDeprecatedResponse withBuild(dev.hathora.cloud_api.models.shared.Build build) {
        Utils.checkNotNull(build, "build");
     ...
     * Ok
     */
    public GetBuildInfoDeprecatedResponse withBuild(Optional<? extends dev.hathora.cloud_api.models.shared.Build> build) {
        Utils.checkNotNull(build, "build");
        this.build = build;
        return this;
    }
