...
class SDKConfiguration {
    ...
    public String userAgent = "speakeasy-sdk/java 2.4.0 2.339.1 0.0.1 dev.hathora.cloud_api";

    private dev.hathora.cloud_api.utils.Hooks _hooks = new dev.hathora.cloud_api.utils.Hooks();
