...
public class MetricsResponse {
    ...
    public Optional<? extends java.util.List<MetricValue>> activeConnections() {
        return activeConnections;
    }

    public Optional<? extends java.util.List<MetricValue>> cpu() {
        return cpu;
    }

    public Optional<? extends java.util.List<MetricValue>> memory() {
        return memory;
    }

    public Optional<? extends java.util.List<MetricValue>> rateEgress() {
        return rateEgress;
    }

    public Optional<? extends java.util.List<MetricValue>> totalEgress() {
        return totalEgress;
    }
    ...
    public MetricsResponse withActiveConnections(java.util.List<MetricValue> activeConnections) {
        Utils.checkNotNull(activeConnections, "activeConnections");
        this.activeConnections = Optional.ofNullable(activeConnections);
        return this;
    }
    
    public MetricsResponse withActiveConnections(Optional<? extends java.util.List<MetricValue>> activeConnections) {
        Utils.checkNotNull(activeConnections, "activeConnections");
        this.activeConnections = activeConnections;
        return this;
    }

    public MetricsResponse withCpu(java.util.List<MetricValue> cpu) {
        Utils.checkNotNull(cpu, "cpu");
        this.cpu = Optional.ofNullable(cpu);
        return this;
    }
    
    public MetricsResponse withCpu(Optional<? extends java.util.List<MetricValue>> cpu) {
        Utils.checkNotNull(cpu, "cpu");
        this.cpu = cpu;
        return this;
    }

    public MetricsResponse withMemory(java.util.List<MetricValue> memory) {
        Utils.checkNotNull(memory, "memory");
        this.memory = Optional.ofNullable(memory);
        return this;
    }
    
    public MetricsResponse withMemory(Optional<? extends java.util.List<MetricValue>> memory) {
        Utils.checkNotNull(memory, "memory");
        this.memory = memory;
        return this;
    }

    public MetricsResponse withRateEgress(java.util.List<MetricValue> rateEgress) {
        Utils.checkNotNull(rateEgress, "rateEgress");
        this.rateEgress = Optional.ofNullable(rateEgress);
        return this;
    }
    
    public MetricsResponse withRateEgress(Optional<? extends java.util.List<MetricValue>> rateEgress) {
        Utils.checkNotNull(rateEgress, "rateEgress");
        this.rateEgress = rateEgress;
        return this;
    }

    public MetricsResponse withTotalEgress(java.util.List<MetricValue> totalEgress) {
        Utils.checkNotNull(totalEgress, "totalEgress");
        this.totalEgress = Optional.ofNullable(totalEgress);
        return this;
    }
    
    public MetricsResponse withTotalEgress(Optional<? extends java.util.List<MetricValue>> totalEgress) {
        Utils.checkNotNull(totalEgress, "totalEgress");
        this.totalEgress = totalEgress;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(MetricsResponse.class,
