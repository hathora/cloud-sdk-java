...
/**
 * RoomAllocation - Metadata on allocated instances of a room.
 */
...
public class RoomAllocation {
    ...
    public RoomAllocation(@JsonProperty("processId") String processId, @JsonProperty("roomAllocationId") String roomAllocationId, @JsonProperty("scheduledAt") OffsetDateTime scheduledAt, @JsonProperty("unscheduledAt") OffsetDateTime unscheduledAt) {
        this.processId = processId;
        this.roomAllocationId = roomAllocationId;
        this.scheduledAt = scheduledAt;
        this.unscheduledAt = unscheduledAt;
