...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            CreateBuildDeprecatedResponse res = sdk.buildV1().createBuildDeprecated()
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            DeleteBuildDeprecatedResponse res = sdk.buildV1().deleteBuildDeprecated()
                .appId("app-af469a92-5b45-4565-b3c4-b79878de67d2")
                .buildId(1)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            GetBuildInfoDeprecatedResponse res = sdk.buildV1().getBuildInfoDeprecated()
                .appId("app-af469a92-5b45-4565-b3c4-b79878de67d2")
                .buildId(1)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            GetBuildsDeprecatedResponse res = sdk.buildV1().getBuildsDeprecated()
                .appId("app-af469a92-5b45-4565-b3c4-b79878de67d2")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            RunBuildDeprecatedResponse res = sdk.buildV1().runBuildDeprecated()
