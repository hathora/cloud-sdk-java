...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            CreateBuildResponse res = sdk.buildV2().createBuild()
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            DeleteBuildResponse res = sdk.buildV2().deleteBuild()
                .appId("app-af469a92-5b45-4565-b3c4-b79878de67d2")
                .buildId(1)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            GetBuildInfoResponse res = sdk.buildV2().getBuildInfo()
                .appId("app-af469a92-5b45-4565-b3c4-b79878de67d2")
                .buildId(1)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            GetBuildsResponse res = sdk.buildV2().getBuilds()
                .appId("app-af469a92-5b45-4565-b3c4-b79878de67d2")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            RunBuildResponse res = sdk.buildV2().runBuild()
